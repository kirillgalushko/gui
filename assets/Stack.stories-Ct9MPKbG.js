import{C as m}from"./Card-DIkemlql.js";import{S as t}from"./Stack-B1GEL4Ty.js";import"./vue.esm-bundler-CPSzUxcr.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const u={title:"Example/Stack",component:t,tags:["autodocs"],argTypes:{direction:{control:{type:"select"},options:["column","row"]},gap:{control:{type:"select"},options:[1,2,3,4,5,6]},alignItems:{control:{type:"select"},options:["start","center","end"]},stretched:{control:{type:"boolean"}}}},r={args:{direction:"column",gap:3},render:a=>({components:{Stack:t,Card:m},setup(){return{args:a}},template:`
      <Stack v-bind="args">
        <Card>Элемент 1</Card>
        1
        <Card>Элемент 2</Card>
