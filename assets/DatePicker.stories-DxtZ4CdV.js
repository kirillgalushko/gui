import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,dt as n}from"./iframe-Z95Hq5ox.js";import{n as r,t as i}from"./DatePicker-DSgN2wO0.js";var a,o,s,c;function l(){return(l=e((()=>{t(),r(),a={title:`Components/DatePicker`,component:i,tags:[`autodocs`],argTypes:{size:{control:`select`,options:[`extra-small`,`small`,`medium`,`large`]},stretched:{control:`boolean`},disabled:{control:`boolean`}}},o={render:e=>({components:{DatePicker:i},setup(){let t=n(new Date);return{args:e,onChange:({value:e})=>{t.value=e},value:t}},template:`<DatePicker v-bind="args" :value="value" :on-change="onChange" />`})},s={render:e=>({components:{DatePicker:i},setup(){let t=n(null);return{args:e,onChange:({value:e})=>{t.value=e},value:t}},template:`<DatePicker v-bind="args" :value="value" :on-change="onChange" />`})},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  render: args => ({
    components: {
      DatePicker
    },
