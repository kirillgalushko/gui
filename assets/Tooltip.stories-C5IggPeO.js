import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./Text-DUT-SggZ.js";import{n as r,t as i}from"./Tooltip-CrGCfLJ5.js";var a,o,s,c,l;function u(){return(u=e((()=>{r(),t(),a={title:`Components/Tooltip`,component:i,tags:[`autodocs`],argTypes:{mode:{control:`select`,options:[`default`,`contrast`]},delay:{control:`object`},stretched:{control:`boolean`}},args:{mode:`default`,delay:{show:200,hide:0}}},o={args:{mode:`default`,delay:{show:200,hide:0}},render:e=>({components:{Tooltip:i,Text:n},setup(){return{args:e}},template:`
      Наведи курсор вот 
      <Tooltip v-bind="args">
        <template #popper>
          Это подсказка
