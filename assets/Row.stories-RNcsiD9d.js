import{R as n}from"./Row-DONxoqQY.js";import{C as c}from"./Card-DIkemlql.js";import"./vue.esm-bundler-CPSzUxcr.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const h={title:"Example/Row",component:n,tags:["autodocs"],argTypes:{fullHeight:{control:"boolean",description:"Устанавливает высоту строки на 100%"},alignItems:{control:"select",description:"Устанавливает высоту строки на 100%",options:["start","center","end"]}}},i=`
      <Row v-bind="args">
        <Card>1<br/>1</Card>
        <Card>2<br/><br/>2</Card>
