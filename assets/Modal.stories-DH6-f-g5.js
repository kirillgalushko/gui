import{e as T,f as S,o as n,b as s,g as a,j as N,n as A,x as u,l as f,y as r,d as B,z as F,A as I,B as $}from"./vue.esm-bundler-wkyDyPDa.js";import{A as q}from"./Action-BPxxLpA1.js";import{I as V}from"./Icon-CQTe_jpK.js";import{T as z}from"./Text-ZsfjhPBs.js";import{_ as D}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{B as c}from"./Button-D1hkFDgi.js";const E={key:0},L={class:"modal"},W={key:0,class:"modal-title"},j={key:1,class:"modal-close"},G={class:"modal-content"},H={key:2,class:"modal-footer"},k=T({__name:"Modal",props:{isOpened:{type:Boolean},onClose:{type:Function},showCloseButton:{type:Boolean},title:{}},setup(t){const e=t,m=$(),x=S(()=>{const o=m!=null&&m.slots.footer?'"footer footer"':"";return e.title?`
      "title close"
      "content content"
      ${o}
    `:`
