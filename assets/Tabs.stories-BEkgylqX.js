import{r as o,k as G,P as y,R as j,o as E,c as H,a as K,x as m,v as X,j as q,O as _,b as L,H as O}from"./vue.esm-bundler-C03mjNA1.js";import{C as f}from"./Card-Bf2gJGck.js";import{T as v}from"./Text-BiqKfc3E.js";import{G as h}from"./Gap-BJezRdZH.js";import{B as g}from"./Button-CxUvpbRe.js";import{u as M}from"./useResize-Cqsa9dvK.js";import{_ as D}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{d as P,a as V,b as J}from"./IconHome2Outline-MrQum_mg.js";import"./Loader-8KcTY6N4.js";import"./IconAccessibleFilled-BdbkCVDv.js";const Q=(a,n)=>{const e=o([]),r=o();return{tabs:e,selectedTab:r,registerTab:t=>{t.getAttribute("data-name")===a&&(r.value=t),e.value.length||(r.value=t),e.value.push(t)},selectTab:t=>{r.value=t;const l=t.getAttribute("data-name");l&&n(l)}}},F=G({__name:"Tabs",props:{value:{},onChange:{type:Function},stretched:{type:Boolean}},setup(a){const n=o(!0),e=a,r=s=>{n.value=!1,e.onChange(s)},c=Q(e.value,r);y("tabs",c),y("stretched",e.stretched);const i=o(),t=o({width:"0px",transform:"translateX(0px)"}),l=()=>{console.log("updateSliderStyle");const s=c.selectedTab.value;s&&(t.value={width:`${s.offsetWidth}px`,transform:`translateX(${s.offsetLeft}px)`})};return j(()=>{l()}),M(i,l),(s,I)=>(E(),H("div",{ref_key:"tabsElementRef",ref:i,class:m(["tabs",{stretched:e.stretched}])},[K("div",{class:m(["slider",{animated:!n.value}]),style:X(t.value)},null,6),q(s.$slots,"default",{},void 0,!0)],2))}}),T=D(F,[["__scopeId","data-v-067d6817"]]);F.__docgenInfo={exportName:"default",displayName:"Tabs",description:"",tags:{},props:[{name:"value",required:!0,type:{name:"string"}},{name:"onChange",required:!0,type:{name:"TSFunctionType"}},{name:"stretched",required:!1,type:{name:"boolean"}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/gui/gui/src/components/Tabs/Tabs.vue"]};const U=["data-name"],z=G({__name:"Tab",props:{name:{}},setup(a){const n=a,e=o(),r=_("tabs"),c=_("stretched"),{registerTab:i,selectTab:t,selectedTab:l}=r||{},s=()=>{e.value&&(t==null||t(e.value))},I=p=>{p.key==="Enter"&&s()};return L(()=>{e.value&&(i==null||i(e.value))}),(p,Y)=>(E(),H("div",{ref_key:"tabRef",ref:e,tabindex:"0",onKeydown:I,onClick:s,"data-name":n.name,class:m(["tab",{stretched:O(c),selected:O(l)===e.value}])},[q(p.$slots,"default",{},void 0,!0)],42,U))}}),C=D(z,[["__scopeId","data-v-26ff5ec9"]]);z.__docgenInfo={exportName:"default",displayName:"Tab",description:"",tags:{},props:[{name:"name",required:!0,type:{name:"string"}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/gui/gui/src/components/Tabs/Tab.vue"]};const le={title:"Components/Tabs",component:T,tags:["autodocs"],argTypes:{stretched:{type:"boolean"}}},W=(a,n)=>`
...
`,d={render:()=>({components:{Tabs:T,Tab:C,Card:f,Text:v,Gap:h,Button:g},setup(){const a=o("Notifications");return{selectedTab:a,handleChangeTab:e=>{a.value=e}}},template:W(`<Tabs :value="selectedTab" :onChange="handleChangeTab">
        ...
        <Tab name="Reports">Reports</Tab>
        <Tab name="Notifications">Notifications</Tab>
      </Tabs>`,!0)})},u={render:()=>({components:{Tabs:T,Tab:C,Card:f,Text:v,Gap:h,Button:g,IconHome2Outline:P,IconABOutline:V,IconAbcOutline:J},setup(){const a=o(!1),n=o("Notifications");return{selectedTab:n,handleChangeTab:c=>{n.value=c},isIcons:a,toggleIcons:()=>{a.value=!a.value}}},template:`
      ...
      `})};var w,x,N;d.parameters={...d.parameters,docs:{...(w=d.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: () => ({
    components: {
      Tabs,
      Tab,
