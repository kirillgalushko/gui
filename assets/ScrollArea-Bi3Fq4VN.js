...
`,(0,c.jsx)(t.pre,{children:(0,c.jsx)(t.code,{className:`language-vue`,children:`<ScrollArea fade :max-height="320" aria-label="История действий">
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`overscroll-behavior`}),` управляет передачей прокрутки родительскому
контейнеру. По умолчанию `,(0,c.jsx)(t.code,{children:`contain`}),`; используйте `,(0,c.jsx)(t.code,{children:`auto`}),`, если после достижения
края области страница должна продолжать прокручиваться.`]}),`
...
ширины содержимого.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`fade`}),` показывает затухание только на тех краях, в направлении которых ещё
можно прокручивать. Без переполнения и на достигнутом краю затухания нет.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`fade-size`}),` задаёт глубину затухания; число интерпретируется как пиксели.`]}),`
`,(0,c.jsxs)(t.li,{children:[`Scroll-aware затухание работает для `,(0,c.jsx)(t.code,{children:`vertical`}),`, `,(0,c.jsx)(t.code,{children:`horizontal`}),` и `,(0,c.jsx)(t.code,{children:`both`}),`.`]}),`
