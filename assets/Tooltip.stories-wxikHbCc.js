import{T as n}from"./Tooltip-bV7eJZNt.js";import{T as i}from"./Text-DzYs2-Qz.js";import"./vue.esm-bundler-JOEmeMwU.js";import"./floating-vue-DqO1PYqm.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const f={title:"Example/Tooltip",component:n,tags:["autodocs"],argTypes:{mode:{control:"select",options:["default","accent"]}},args:{mode:"default"}},t={args:{mode:"default"},render:o=>({components:{Tooltip:n,Text:i},setup(){return{args:o}},template:`
      Наведи курсор вот 
      <Tooltip v-bind="args">
        <template #popper>
          Это подсказка
