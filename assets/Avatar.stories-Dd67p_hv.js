import{k as _,r as A,D as x,o as y,c as I,K as z,L as O,a as b,j as q,m as E}from"./vue.esm-bundler-W7H8yL8W.js";import{_ as U}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{d}from"./IconUserOutline-DG8miPGi.js";import"./IconAccessibleFilled-Bv--GMkI.js";const w=["src"],v=_({__name:"Avatar",props:{shape:{default:"circle"},color:{default:"default"},src:{},size:{default:"40px"}},setup(a){const e=a,o=A(!1);function g(){o.value=!0}const h=x(()=>{const r=e.shape==="square"?{borderRadius:`calc(${e.size} / 4)`}:{};return{width:e.size,height:e.size,fontSize:`calc(${e.size} / 2.5)`,...r}});return(r,L)=>(y(),I("div",E({style:h.value,class:["avatar",e.shape,e.color]},r.$attrs),[z(b("img",{onLoad:g,class:"avatar-image",src:e.src},null,40,w),[[O,o.value]]),q(r.$slots,"default",{},void 0,!0)],16))}}),s=U(v,[["__scopeId","data-v-efe81b56"]]);v.__docgenInfo={exportName:"default",displayName:"Avatar",description:"",tags:{},props:[{name:"shape",required:!1,type:{name:"union",elements:[{name:'"square"'},{name:'"circle"'}]},defaultValue:{func:!1,value:"'circle'"}},{name:"color",required:!1,type:{name:"union",elements:[{name:'"default"'},{name:'"secondary"'},{name:'"outlined"'}]},defaultValue:{func:!1,value:"'default'"}},{name:"src",required:!1,type:{name:"string"}},{name:"size",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'40px'"}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/gui/gui/src/components/Avatar/Avatar.vue"]};const f=""+new URL("avatar-example-QCCGernO.png",import.meta.url).href,W={title:"Components/Avatar",component:s,tags:["autodocs"],argTypes:{shape:{control:{type:"select"},options:["square","circle"]},color:{control:{type:"select"},options:["default","secondary","outlined"]},size:{control:{type:"text"}}},args:{size:"60px"}},t={args:{},render:a=>({components:{Avatar:s,IconUserOutline:d},setup(){return{args:a,avatarExample:f}},template:`
