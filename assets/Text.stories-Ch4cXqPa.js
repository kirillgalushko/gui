import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./Text-Cy6Fu2qM.js";var r,i,a,o,s,c;function l(){return(l=e((()=>{t(),r={title:`Components/Text`,component:n,tags:[`autodocs`],argTypes:{typography:{control:`select`,options:[`title-1`,`title-2`,`title-3`,`title-4`,`title-5`,`title-6`,`title-7`,`title-8`,`title-9`,`title-10`,`subtitle-1`,`subtitle-2`,`subtitle-3`,`subtitle-4`,`label-1`,`label-2`,`label-3`,`paragraph-1`,`paragraph-2`]},Element:{control:`select`,options:[`h1`,`h2`,`h3`,`h4`,`h5`,`h6`,`p`,`span`,`div`]},color:{control:`select`,options:[`default`,`inherit`,`secondary`,`negative`]},inline:{control:`boolean`},textAlign:{control:`select`,options:[`inherit`,`start`,`center`,`end`]}}},i=`АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЧЦШЩЬЪЫЭЮЯабвгдеёжзийклмнопрстуфхчцшщьъыэюя`,a={args:{typography:`paragraph-1`,color:`default`,clamp:2,ellipsis:!0,inline:!1,textAlign:`start`},render:e=>({components:{Text:n},setup(){return{args:e,text:i}},template:`<Text v-bind="args">{{text}}</Text>`})},o={render:()=>({components:{Text:n},template:`
      <div>
