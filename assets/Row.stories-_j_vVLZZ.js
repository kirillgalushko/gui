import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./Card-Dv6sF5an.js";import{n as r,t as i}from"./Row-BWdc-r6B.js";var a,o,s,c,l;function u(){return(u=e((()=>{r(),t(),a={title:`Components/Row`,component:i,tags:[`autodocs`],argTypes:{fullHeight:{control:`boolean`},alignItems:{control:`select`,options:[`start`,`center`,`end`]}}},o=`
      <Row v-bind="args">
        <Card>1<br/>1</Card>
        <Card>2<br/><br/>2</Card>
