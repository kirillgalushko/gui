import{T as a}from"./Text-CzGbCvHO.js";import"./vue.esm-bundler-IF9MMzN9.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const u={title:"Components/Text",component:a,tags:["autodocs"],argTypes:{typography:{control:"select",options:["title-1","title-2","title-3","title-4","subtitle-1","subtitle-2","subtitle-3","subtitle-4","label-1","label-2","label-3","paragraph-1","paragraph-2"]},Element:{control:"select",options:["h1","h2","h3","h4","h5","h6","p","span","div"]},color:{control:"select",options:["default","inherit","secondary"]}}},c="АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЧЦШЩЬЪЫЭЮЯабвгдеёжзийклмнопрстуфхчцшщьъыэюя",t={args:{typography:"paragraph-1",color:"default",clamp:2,ellipsis:!0},render:p=>({components:{Text:a},setup(){return{args:p,text:c}},template:'<Text v-bind="args">{{text}}</Text>'})},e={render:()=>({components:{Text:a},template:`
      <div>
