import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{h as t,j as n,n as r}from"./gui-icons.es-BLyOnAQu.js";import{n as i,t as a}from"./Input-yJ2E5o3N.js";import{n as o,t as s}from"./Stack-C4ahZnk7.js";var c,l,u,d,f,p,m,h;function g(){return(g=e((()=>{i(),r(),o(),c={title:`Components/Input`,component:a,tags:[`autodocs`],argTypes:{disabled:{type:`boolean`},invalid:{type:`boolean`},size:{control:`select`,options:[`extra-small`,`small`,`medium`,`large`]}}},l={args:{placeholder:`Placeholder`,value:`Value`},render:e=>({components:{Input:a},setup(){return{args:e}},template:`<Input v-bind="args" v-model="args.value" />`})},u={args:{placeholder:`Placeholder`,value:`Value`},render:e=>({components:{Input:a,IconSearchOutline:t},setup(){return{args:e}},template:`
