import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,ct as n}from"./iframe-DSPFKwNv.js";import{n as r,t as i}from"./Button-BMCIb-MW.js";import{n as a,t as o}from"./Gap-BztRMGj8.js";import{i as s,n as c,r as l,t as u}from"./SelectOption-C_cbjkuG.js";var d,f,p,m;function h(){return(h=e((()=>{s(),c(),t(),r(),a(),d={title:`Components/Select`,component:l,tags:[`!autodocs`],argTypes:{size:{control:`select`,options:[`extra-small`,`small`,`medium`,`large`]},mode:{control:`select`,options:[`default`,`outline`]}}},f={args:{label:`Выберите тему`,name:`theme`,mode:`outline`},render:e=>({components:{Select:l,SelectOption:u},setup(){let t=n(`dark`);return{args:e,handleChange:e=>{t.value=e.value},selectedOption:t}},template:`
    <div>
