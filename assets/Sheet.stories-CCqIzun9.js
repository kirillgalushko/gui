import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./Button-BMCIb-MW.js";import{n as r,t as i}from"./Text-BGOG7_PZ.js";import{n as a,t as o}from"./Gap-BztRMGj8.js";import{n as s,t as c}from"./Sheet-Df02Shf2.js";import{n as l,t as u}from"./Input-yJ2E5o3N.js";import{n as d,t as f}from"./useModal-CKl9PXt8.js";var p,m,h,g,_,v,y,b,x,S;function C(){return(C=e((()=>{t(),a(),l(),s(),r(),f(),p={title:`Components/Sheet`,component:c,tags:[`autodocs`],argTypes:{isOpened:{control:{type:`boolean`}},title:{control:{type:`text`}},description:{control:{type:`text`}},showCloseButton:{control:{type:`boolean`}},side:{control:{type:`select`},options:[`top`,`right`,`bottom`,`left`]},size:{control:{type:`select`},options:[`auto`,`small`,`medium`,`large`,`full`]},mode:{control:{type:`select`},options:[`default`,`floating`]},rounded:{control:{type:`boolean`}}},args:{isOpened:!0,showCloseButton:!0,title:`Настройки объекта`,description:`Измените параметры объявления и сохраните результат.`,side:`right`,mode:`default`,rounded:!0},parameters:{docs:{story:{inline:!1,iframeHeight:520}}}},m={render:e=>({components:{Button:n,Gap:o,Input:u,Sheet:c},setup(){return{args:e}},template:`
      <Sheet v-bind="args">
    ...
    `})},h={args:{isOpened:!1},render:e=>({components:{Button:n,Gap:o,Input:u,Sheet:c},setup(){let{show:t,close:n,visible:r}=d();return{args:e,show:t,close:n,visible:r}},template:`
    ...
    `})},g={args:{side:`left`,size:`small`},render:e=>({components:{Button:n,Sheet:c,Text:i},setup(){return{args:e}},template:`
      <Sheet v-bind="args">
        <Text typography="paragraph-1">
          Левая панель подходит для фильтров, навигации и дополнительных настроек.
        </Text>
      </Sheet>
    `})},_={args:{side:`bottom`},render:e=>({components:{Button:n,Sheet:c,Text:i},setup(){return{args:e}},template:`
      <Sheet v-bind="args">
        <Text typography="paragraph-1">
          Нижняя панель удобна для мобильных действий и кратких форм.
        </Text>
      </Sheet>
    `})},v={args:{mode:`floating`},render:e=>({components:{Button:n,Gap:o,Input:u,Sheet:c},setup(){return{args:e}},template:`
      <Sheet v-bind="args">
        <Input placeholder="Название объявления" value="Квартира у парка" />
        <Gap :size="4" />
        <Input placeholder="Стоимость" value="120 000" />
    ...
    `})},y={args:{title:void 0,description:void 0},render:e=>({components:{Button:n,Gap:o,Sheet:c,Text:i},setup(){return{args:e}},template:`
      <Sheet v-bind="args">
        <template #header>
    ...
    `})},b={args:{mode:`floating`,side:`bottom`},render:e=>({components:{Button:n,Sheet:c,Text:i},setup(){return{args:e}},template:`
      <Sheet v-bind="args">
        <Text typography="paragraph-1">
    ...
    `})},x={args:{side:`bottom`,size:`full`},render:e=>({components:{Button:n,Sheet:c,Text:i},setup(){return{args:e}},template:`
      <Sheet v-bind="args">
        <Text typography="paragraph-1">
