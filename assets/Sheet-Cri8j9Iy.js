...
Панель телепортируется в `,(0,c.jsx)(t.code,{children:`body`}),`, поэтому всегда позиционируется относительно viewport и не обрезается родительским контейнером.
Внутри `,(0,c.jsx)(t.code,{children:`Sheet`}),` использует `,(0,c.jsx)(t.code,{children:`Card`}),`: `,(0,c.jsx)(t.code,{children:`SheetHeader`}),`, `,(0,c.jsx)(t.code,{children:`SheetContent`}),` и `,(0,c.jsx)(t.code,{children:`SheetFooter`}),` — типизированные
переэкспорты соответствующих секций Card.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`contentStretched`}),` — растягивает внутренний контейнер default slot через flex на всю доступную content-область и скрывает его собственный overflow. Используйте для дочерних flex-layout, которые управляют прокруткой самостоятельно.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`mode`}),` — отображение панели: `,(0,c.jsx)(t.code,{children:`default`}),` прилегает к краю viewport с `,(0,c.jsx)(t.code,{children:`border-radius: 0`}),`, `,(0,c.jsx)(t.code,{children:`floating`}),` оставляет отступ от краёв.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.code,{children:`rounded`}),` — скругляет floating-панель; обычная панель всегда остаётся без скругления.`]}),`
