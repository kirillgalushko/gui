import{I as a,d as I,a as g}from"./Input-C8b35x8i.js";import"./vue.esm-bundler-C03mjNA1.js";import"./IconAccessibleFilled-BdbkCVDv.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const f={title:"Components/Input",component:a,tags:["autodocs"],argTypes:{disabled:{type:"boolean"}}},n={args:{placeholder:"Placeholder",value:"Value"},render:e=>({components:{Input:a},setup(){return{args:e}},template:'<Input v-bind="args" />'})},t={args:{placeholder:"Placeholder",value:"Value"},render:e=>({components:{Input:a,IconSearchOutline:I},setup(){return{args:e}},template:`
      <Input v-bind="args">
