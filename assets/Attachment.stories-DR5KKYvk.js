import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{B as t,C as n,G as r,O as i,a,yt as o}from"./iframe-Z95Hq5ox.js";import{n as s,t as c}from"./_plugin-vue_export-helper-BqBa3wPr.js";import{$t as l,F as u,Vt as d,kt as f,l as p,lt as m,n as h,r as g,s as _,y as v}from"./gui-icons.es-B0LP8gzK.js";import{n as y,t as b}from"./Button-DEy7MrHI.js";import{a as x,c as S,d as C,f as w,i as T,l as E,m as D,n as O,o as k,p as A,r as j,s as M,t as N,u as P}from"./AttachmentTitle-DwlaW2wv.js";var F,I;function L(){return(L=e((()=>{a(),F=[`data-orientation`],I=i({__name:`AttachmentGroup`,props:{orientation:{default:`vertical`}},setup(e){let i=e;return(e,a)=>(t(),n(`div`,{class:o([`attachment-group`,i.orientation]),"data-orientation":i.orientation,role:`list`},[r(e.$slots,`default`,{},void 0,!0)],10,F))}})})))()}var R;function z(){return(z=e((()=>{L(),s(),R=c(I,[[`__scopeId`,`data-v-857b5afd`]]),I.__docgenInfo=Object.assign({displayName:I.name??I.__name},{exportName:`default`,displayName:`AttachmentGroup`,description:``,tags:{},props:[{name:`orientation`,required:!1,type:{name:`AttachmentOrientation`},defaultValue:{func:!1,value:`"vertical"`}}],slots:[{name:`default`}],sourceFiles:[`/home/runner/work/gui/gui/src/components/Attachment/AttachmentGroup.vue`]})})))()}var B,V,H,U,W,G;function K(){return(K=e((()=>{h(),y(),D(),w(),P(),S(),k(),z(),T(),O(),B={title:`Components/Attachment`,component:A,tags:[`autodocs`],args:{orientation:`horizontal`,size:`medium`,state:`done`,stretched:!0},argTypes:{orientation:{control:{type:`select`},options:[`horizontal`,`vertical`]},size:{control:{type:`select`},options:[`large`,`medium`,`small`,`extra-small`]},state:{control:{type:`select`},options:[`idle`,`uploading`,`processing`,`error`,`done`]}}},V={render:e=>({components:{Attachment:A,AttachmentAction:C,AttachmentActions:E,AttachmentContent:M,AttachmentDescription:x,AttachmentMedia:j,AttachmentTitle:N,IconFileOutline:m,IconLoader2Outline:u,IconXOutline:g},setup:()=>({args:e}),template:`
    ...
    `})},H={render:()=>({components:{Attachment:A,AttachmentContent:M,AttachmentDescription:x,AttachmentAction:C,AttachmentActions:E,AttachmentGroup:R,AttachmentMedia:j,AttachmentTitle:N,IconXOutline:g},template:`
    ...
    `})},U={render:()=>({components:{Attachment:A,AttachmentAction:C,AttachmentActions:E,AttachmentContent:M,AttachmentDescription:x,AttachmentGroup:R,AttachmentMedia:j,AttachmentTitle:N,IconAlertSquareRoundedOutline:l,IconCheckOutline:d,IconClockOutline:f,IconFileOutline:m,IconLoader2Outline:u,IconRefreshOutline:v,IconXOutline:g},template:`
      <AttachmentGroup>
    ...
    `})},W={render:()=>({components:{Attachment:A,AttachmentAction:C,AttachmentActions:E,AttachmentContent:M,AttachmentDescription:x,AttachmentGroup:R,AttachmentMedia:j,AttachmentTitle:N,Button:b,IconFileOutline:m,IconTrashOutline:p,IconUploadOutline:_},template:`
