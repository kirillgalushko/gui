import{T as n}from"./Tooltip-C5WPrTKh.js";import{T as i}from"./Text-BBd-egn4.js";import"./vue.esm-bundler-DUApOrFq.js";import"./floating-vue-BM4SLnXu.js";import"./floating-ui.dom.browser.min-Dq8c3VDt.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const x={title:"Example/Tooltip",component:n,tags:["autodocs"],argTypes:{mode:{control:"select",options:["default","accent"]}},args:{mode:"default"}},t={args:{mode:"default"},render:o=>({components:{Tooltip:n,Text:i},setup(){return{args:o}},template:`
      Наведи курсор вот 
      <Tooltip v-bind="args">
        <template #popper>
          Это подсказка
