import{j as M,K as $,r as h,L,D as N,e as B,f as E,t as d,g as f,M as R,N as w,m as j,v as q}from"./vue.esm-bundler-0yPEwasB.js";import{_ as z}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{I as b}from"./Icon-DuNk9YsD.js";const S=M({__name:"Input",props:$({maxWidth:{default:"100%"}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(e){const p=h(),u=h(),m=L(e,"modelValue"),k=e,D=N(()=>{const t=c=>{var i,g;return(i=c.value)!=null&&i.clientWidth?((g=c.value)==null?void 0:g.clientWidth)+20:12},r=t(p),l=t(u);return`padding-left: ${r}px; padding-right: ${l}px;`});return(t,r)=>(B(),E("div",{style:q({maxWidth:k.maxWidth}),class:"input-container"},[d("div",{ref_key:"leftAdornment",ref:p,class:"adornment left-adornment"},[f(t.$slots,"leftAdornment",{},void 0,!0)],512),R(d("input",j(t.$attrs,{"onUpdate:modelValue":r[0]||(r[0]=l=>m.value=l),style:D.value,class:["input"]}),null,16),[[w,m.value]]),d("div",{ref_key:"rightAdornment",ref:u,class:"adornment right-adornment"},[f(t.$slots,"rightAdornment",{},void 0,!0)],512)],4))}}),s=z(S,[["__scopeId","data-v-9771ebc5"]]);S.__docgenInfo={exportName:"default",displayName:"Input",description:"",tags:{},props:[{name:"maxWidth",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'100%'"}}],slots:[{name:"leftAdornment"},{name:"rightAdornment"}],sourceFiles:["/home/runner/work/gui/gui/src/components/Input/Input.vue"]};const O={title:"Example/Input",component:s,tags:["autodocs"]},a={args:{placeholder:"Placeholder",value:"Value"},render:e=>({components:{Input:s},setup(){return{args:e}},template:'<Input v-bind="args" />'})},n={args:{placeholder:"Placeholder",value:"Value"},render:e=>({components:{Input:s,Icon:b},setup(){return{args:e}},template:`
      <Input v-bind="args">
