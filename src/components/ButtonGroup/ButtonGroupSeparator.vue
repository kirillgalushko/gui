...
const context = inject(buttonGroupContextKey, { orientation: 'horizontal' as ButtonGroupOrientation });
...
<template>
  <div :class="['button-group-separator', separatorOrientation]" role="separator"
