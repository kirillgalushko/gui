...
export const Dialog = ac(() => import('./components/Dialog/Dialog.vue'));
export const DialogTrigger = ac(() => import('./components/Dialog/DialogTrigger.vue'));
export const DialogContent = ac(() => import('./components/Dialog/DialogContent.vue'));
export const DialogHeader = ac(() => import('./components/Dialog/DialogHeader.vue'));
export const DialogTitle = ac(() => import('./components/Dialog/DialogTitle.vue'));
export const DialogDescription = ac(() => import('./components/Dialog/DialogDescription.vue'));
export const DialogFooter = ac(() => import('./components/Dialog/DialogFooter.vue'));
