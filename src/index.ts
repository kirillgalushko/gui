...
export const AdaptiveModal = ac(() => import('./components/AdaptiveModal/AdaptiveModal.vue'));
export const Avatar = ac(() => import('./components/Avatar/Avatar.vue'));
export const Button = ac(() => import('./components/Button/Button.vue'));
export const ButtonGroup = ac(() => import('./components/ButtonGroup/ButtonGroup.vue'));
export const ButtonGroupSeparator = ac(() => import('./components/ButtonGroup/ButtonGroupSeparator.vue'));
export const ButtonGroupText = ac(() => import('./components/ButtonGroup/ButtonGroupText.vue'));
