import { r as e, t } from "./useChart-BUu153me.js";
...
//#endregion
//#region src/components/Chart/ChartDoughnut.vue
var c = /* @__PURE__ */ i({
	__name: "ChartDoughnut",
	props: {
		data: {},
		options: {},
		plugins: {},
	...
	setup(i) {
		let c = i, { chartData: l, chartOptions: u, chartPlugins: d, containerStyle: f } = t("doughnut", c);
		return (t, i) => (o(), n("div", {
