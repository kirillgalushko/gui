import { a as e, t } from "./useChart-BUu153me.js";
...
//#endregion
//#region src/components/Chart/ChartPie.vue
var c = /* @__PURE__ */ i({
	__name: "ChartPie",
	props: {
		data: {},
	...
	setup(i) {
		let c = i, { chartData: l, chartOptions: u, chartPlugins: d, containerStyle: f } = t("pie", c);
		return (t, i) => (o(), n("div", {
