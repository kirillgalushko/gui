...
import { D as n, M as r, a as i, h as a, t as o, u as s, x as c } from "./gui-icons.es-B9g1VPOq.js";
		...
		return M(() => T.file, (e) => {
			...
			default: N(() => [
				w(m, { variant: R.value ? "image" : "icon" }, {
					...
					})) : T.state === "error" ? (O(), b(j(r), { key: 2 })) : T.state === "done" ? (O(), b(j(n), { key: 3 })) : T.state === "processing" ? (O(), b(j(a), { key: 4 })) : (O(), b(j(c), { key: 5 }))]),
					_: 1
				}, 8, ["variant"]),
				w(f, null, {
					default: N(() => [
