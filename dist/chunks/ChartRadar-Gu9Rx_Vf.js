import { s as e, t } from "./useChart-BUu153me.js";
...
//#endregion
//#region src/components/Chart/ChartRadar.vue
var c = /* @__PURE__ */ i({
	__name: "ChartRadar",
	props: {
		data: {},
	...
	setup(i) {
		let c = i, { chartData: l, chartOptions: u, chartPlugins: d, containerStyle: f } = t("radar", c);
		return (t, i) => (o(), n("div", {
