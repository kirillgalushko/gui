...
import '../assets/Chip-VWHzeZQT.css';const y = ["disabled", "role", "aria-checked", "aria-pressed"], B = { class: "chip-label" }, x = /* @__PURE__ */ m({
  __name: "Chip",
  props: {
    value: {},
    size: { default: "medium" },
...
}), j = /* @__PURE__ */ z(x, [["__scopeId", "data-v-e21db3fe"]]);
export {
  j as default
};
