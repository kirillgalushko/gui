...
function n(n) {
	return t(e(n * 2.55), 0, 255);
}
function r(n) {
	return t(e(n * 255), 0, 255);
}
function i(n) {
	return t(e(n / 2.55) / 100, 0, 1);
}
function a(n) {
	return t(e(n * 100), 0, 100);
}
var o = {
	0: 0,
	1: 1,
	...
	e: 14,
	f: 15
}, s = [..."0123456789ABCDEF"], c = (e) => s[e & 15], l = (e) => s[(e & 240) >> 4] + s[e & 15], u = (e) => (e & 240) >> 4 == (e & 15), d = (e) => u(e.r) && u(e.g) && u(e.b) && u(e.a);
function f(e) {
	var t = e.length, n;
	return e[0] === "#" && (t === 4 || t === 5 ? n = {
		...
		g: o[e[3]] << 4 | o[e[4]],
		b: o[e[5]] << 4 | o[e[6]],
		a: t === 9 ? o[e[7]] << 4 | o[e[8]] : 255
	})), n;
}
var p = (e, t) => e < 255 ? t(e) : "";
function m(e) {
	var t = d(e) ? c : l;
	return e ? "#" + t(e.r) + t(e.g) + t(e.b) + p(e.a, t) : void 0;
}
var h = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/;
function g(e, t, n) {
...
function b(e) {
	...
	return i !== a && (l = i - a, c = o > .5 ? l / (2 - i - a) : l / (i + a), s = y(t, n, r, l, i), s = s * 60 + .5), [
		s | 0,
		c || 0,
		o
	];
...
function x(e, t, n, i) {
	return (Array.isArray(t) ? e(t[0], t[1], t[2]) : e(t, n, i)).map(r);
}
function S(e, t, n) {
	return x(g, e, t, n);
}
...
function E(e) {
	let t = h.exec(e), i = 255, a;
	if (!t) return;
	t[5] !== a && (i = t[6] ? n(+t[5]) : r(+t[5]));
	let o = T(+t[2]), s = t[3] / 100, c = t[4] / 100;
	return a = t[1] === "hwb" ? C(o, s, c) : t[1] === "hsv" ? w(o, s, c) : S(o, s, c), {
		r: a[0],
		g: a[1],
		b: a[2],
		a: i
...
function D(e, t) {
	var n = b(e);
	n[0] = T(n[0] + t), n = S(n), e.r = n[0], e.g = n[1], e.b = n[2];
}
function ee(e) {
	if (!e) return;
	let t = b(e), n = t[0], r = a(t[1]), o = a(t[2]);
	return e.a < 255 ? `hsla(${n}, ${r}%, ${o}%, ${i(e.a)})` : `hsl(${n}, ${r}%, ${o}%)`;
}
var O = {
	x: "dark",
	Z: "light",
...
function ne() {
	let e = {}, t = Object.keys(te), n = Object.keys(O), r, i, a, o, s;
	for (r = 0; r < t.length; r++) {
		for (o = s = t[r], i = 0; i < n.length; i++) a = n[i], s = s.replace(a, O[a]);
		a = parseInt(te[o], 16), e[s] = [
			a >> 16 & 255,
			a >> 8 & 255,
			a & 255
		];
...
var ae = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/;
function oe(e) {
	let r = ae.exec(e), i = 255, a, o, s;
	if (r) {
		if (r[7] !== a) {
			let e = +r[7];
			i = r[8] ? n(e) : t(e * 255, 0, 255);
		}
		return a = +r[1], o = +r[3], s = +r[5], a = 255 & (r[2] ? n(a) : t(a, 0, 255)), o = 255 & (r[4] ? n(o) : t(o, 0, 255)), s = 255 & (r[6] ? n(s) : t(s, 0, 255)), {
			r: a,
			g: o,
			b: s,
			a: i
...
function se(e) {
	return e && (e.a < 255 ? `rgba(${e.r}, ${e.g}, ${e.b}, ${i(e.a)})` : `rgb(${e.r}, ${e.g}, ${e.b})`);
}
var ce = (e) => e <= .0031308 ? e * 12.92 : e ** (1 / 2.4) * 1.055 - .055, le = (e) => e <= .04045 ? e / 12.92 : ((e + .055) / 1.055) ** 2.4;
function ue(e, t, n) {
	let a = le(i(e.r)), o = le(i(e.g)), s = le(i(e.b));
	return {
		r: r(ce(a + n * (le(i(t.r)) - a))),
		g: r(ce(o + n * (le(i(t.g)) - o))),
		b: r(ce(s + n * (le(i(t.b)) - s))),
		a: e.a + n * (t.a - e.a)
	};
}
function de(e, t, n) {
	if (e) {
		let r = b(e);
		r[t] = Math.max(0, Math.min(r[t] + r[t] * n, t === 0 ? 360 : 1)), r = S(r), e.r = r[0], e.g = r[1], e.b = r[2];
	}
}
function fe(e, t) {
...
function me(e) {
	return e.charAt(0) === "r" ? oe(e) : E(e);
}
var he = class t {
	constructor(e) {
		if (e instanceof t) return e;
		let n = typeof e, r;
		n === "object" ? r = pe(e) : n === "string" && (r = f(e) || ie(e) || me(e)), this._rgb = r, this._valid = !!r;
	}
	get valid() {
		return this._valid;
	}
	...
	hslString() {
		return this._valid ? ee(this._rgb) : void 0;
	}
	mix(e, t) {
		if (e) {
	...
	interpolate(e, t) {
		return e && (this._rgb = ue(this._rgb, e._rgb, t)), this;
	}
	clone() {
	...
	greyscale() {
		let t = this._rgb;
		return t.r = t.g = t.b = e(t.r * .3 + t.g * .59 + t.b * .11), this;
	}
	opaquer(e) {
		let t = this._rgb;
		return t.a *= 1 + e, this;
...
var ve = (e, t) => typeof e == "string" && e.endsWith("%") ? parseFloat(e) / 100 : +e / t, ye = (e, t) => typeof e == "string" && e.endsWith("%") ? parseFloat(e) / 100 * t : +e;
function F(e, t, n) {
...
function Te(e, t) {
	return we(e, t, { merger: Ee });
}
function Ee(e, t, n) {
	if (!Se(e)) return;
	let r = t[e], i = n[e];
	j(r) && j(i) ? Te(r, i) : Object.prototype.hasOwnProperty.call(t, e) || (t[e] = xe(i));
}
var De = {
	"": (e) => e,
	x: (e) => e.x,
...
function Ae(e, t) {
	return (De[t] || (De[t] = ke(t)))(e);
}
function je(e) {
	return e.charAt(0).toUpperCase() + e.slice(1);
}
var Me = (e) => e !== void 0, Ne = (e) => typeof e == "function", Pe = (e, t) => {
...
var L = Math.PI, R = 2 * L, Ie = R + L, Le = Infinity, Re = L / 180, z = L / 2, ze = L / 4, Be = L * 2 / 3, Ve = Math.log10, B = Math.sign;
function He(e, t, n) {
...
function Ue(e) {
	let t = Math.round(e);
	e = He(e, t, e / 1e3) ? t : e;
	let n = 10 ** Math.floor(Ve(e)), r = e / n;
...
function Ke(e) {
	return !Ge(e) && !isNaN(parseFloat(e)) && isFinite(e);
}
function qe(e, t) {
	let n = Math.round(e);
	return n - t <= e && n + t >= e;
...
var it = (e, t, n, r) => rt(e, n, r ? (r) => {
	let i = e[r][t];
	return i < n || i === n && e[r + 1][t] === n;
} : (r) => e[r][t] < n), at = (e, t, n) => rt(e, n, (r) => e[r][t] >= n);
function ot(e, t, n) {
	let r = 0, i = e.length;
	for (; r < i && e[r] < t;) r++;
	for (; i > r && e[i - 1] > n;) i--;
...
function lt(e, t) {
	...
	i !== -1 && r.splice(i, 1), !(r.length > 0) && (st.forEach((t) => {
		delete e[t];
	}), delete e._chartjs);
}
function ut(e) {
...
var mt = (e) => e === "start" ? "left" : e === "end" ? "right" : "center", W = (e, t, n) => e === "start" ? t : e === "end" ? n : (t + n) / 2, ht = (e, t, n, r) => e === (r ? "left" : "right") ? n : e === "center" ? (t + n) / 2 : t;
function gt(e, t, n) {
	...
	if (e._sorted) {
		...
		if (p) {
			if (i = Math.min(it(c, u, d).lo, n ? r : it(t, u, o.getPixelForValue(d)).lo), l) {
		...
		if (m) {
			let e = Math.max(it(c, o.axis, f, !0).hi + 1, n ? 0 : it(t, u, o.getPixelForValue(f), !0).hi + 1);
			if (l) {
...
var vt = (e) => e === 0 || e === 1, yt = (e, t, n) => -(2 ** (10 * --e) * Math.sin((e - t) * R / n)), bt = (e, t, n) => 2 ** (-10 * e) * Math.sin((e - t) * R / n) + 1, xt = {
	linear: (e) => e,
	easeInQuad: (e) => e * e,
	easeOutQuad: (e) => -e * (e - 2),
	...
	easeInOutExpo: (e) => vt(e) ? e : e < .5 ? .5 * 2 ** (10 * (e * 2 - 1)) : .5 * (-(2 ** (-10 * (e * 2 - 1))) + 2),
	easeInCirc: (e) => e >= 1 ? e : -(Math.sqrt(1 - e * e) - 1),
	easeOutCirc: (e) => Math.sqrt(1 - --e * e),
	easeInOutCirc: (e) => (e /= .5) < 1 ? -.5 * (Math.sqrt(1 - e * e) - 1) : .5 * (Math.sqrt(1 - (e -= 2) * e) + 1),
	easeInElastic: (e) => vt(e) ? e : yt(e, .075, .3),
	easeOutElastic: (e) => vt(e) ? e : bt(e, .075, .3),
	easeInOutElastic(e) {
		let t = .1125, n = .45;
		return vt(e) ? e : e < .5 ? .5 * yt(e * 2, t, n) : .5 + .5 * bt(e * 2 - 1, t, n);
	},
	easeInBack(e) {
	...
	easeInBounce: (e) => 1 - xt.easeOutBounce(1 - e),
	easeOutBounce(e) {
		let t = 7.5625, n = 2.75;
		return e < 1 / n ? t * e * e : e < 2 / n ? t * (e -= 1.5 / n) * e + .75 : e < 2.5 / n ? t * (e -= 2.25 / n) * e + .9375 : t * (e -= 2.625 / n) * e + .984375;
	},
	easeInOutBounce: (e) => e < .5 ? xt.easeInBounce(e * 2) * .5 : xt.easeOutBounce(e * 2 - 1) * .5 + .5
};
function St(e) {
...
function Ct(e) {
	return St(e) ? e : new he(e);
}
function wt(e) {
	return St(e) ? e : new he(e).saturate(.5).darken(.1).hexString();
}
var Tt = [
	"x",
	"y",
...
function At(e, t) {
	t ||= {};
	let n = e + JSON.stringify(t), r = kt.get(n);
	return r || (r = new Intl.NumberFormat(e, t), kt.set(n, r)), r;
}
function jt(e, t, n) {
	return At(t, n).format(e);
}
var Mt = {
	values(e) {
		return A(e) ? e : "" + e;
	...
	numeric(e, t, n) {
		...
		if (n.length > 1) {
			...
			(t < 1e-4 || t > 0x38d7ea4c68000) && (i = "scientific"), a = Nt(e, n);
		}
		let o = Ve(Math.abs(a)), s = isNaN(o) ? 1 : Math.max(Math.min(-1 * Math.floor(o), 20), 0), c = {
			notation: i,
			minimumFractionDigits: s,
			maximumFractionDigits: s
		};
		return Object.assign(c, this.options.ticks.format), jt(e, r, c);
	},
	logarithmic(e, t, n) {
		if (e === 0) return "0";
		let r = n[t].significand || e / 10 ** Math.floor(Ve(e));
		return [
			1,
			2,
			3,
			...
			10,
			15
		].includes(r) || t > .8 * n.length ? Mt.numeric.call(this, e, t, n) : "";
	}
};
function Nt(e, t) {
...
var It = Object.create(null), Lt = Object.create(null);
function Rt(e, t) {
	if (!t) return e;
	let n = t.split(".");
...
function zt(e, t, n) {
	return typeof t == "string" ? we(Rt(e, t), n) : we(Rt(e, ""), t);
}
var G = /* #__PURE__ */ new class {
	constructor(e, t) {
		this.animation = void 0, this.backgroundColor = "rgba(0,0,0,0.1)", this.borderColor = "rgba(0,0,0,0.1)", this.color = "#666", this.datasets = {}, this.devicePixelRatio = (e) => e.chart.platform.getDevicePixelRatio(), this.elements = {}, this.events = [
			...
			lineHeight: 1.2,
			weight: null
		}, this.hover = {}, this.hoverBackgroundColor = (e, t) => wt(t.backgroundColor), this.hoverBorderColor = (e, t) => wt(t.borderColor), this.hoverColor = (e, t) => wt(t.color), this.indexAxis = "x", this.interaction = {
			mode: "nearest",
			intersect: !0,
			includeInvisible: !1
	...
	route(e, t, n, r) {
		let i = Rt(this, e), a = Rt(this, n), o = "_" + t;
...
function Ht(e, t, n, r) {
	...
	for (c = 0; c < s; c++) if (d = n[c], d != null && !A(d)) o = Vt(e, i, a, o, d);
	else if (A(d)) for (l = 0, u = d.length; l < u; l++) f = d[l], f != null && !A(f) && (o = Vt(e, i, a, o, f));
	e.restore();
	let p = a.length / 2;
	if (p > n.length) {
...
function Kt(e, t, n, r, i) {
	let a, o, s, c, l, u, d, f, p = t.pointStyle, m = t.rotation, h = t.radius, g = (m || 0) * Re;
	...
	if (!(isNaN(h) || h <= 0)) {
		switch (e.beginPath(), p) {
			default:
				...
				break;
			case "triangle":
				u = i ? i / 2 : h, e.moveTo(n + Math.sin(g) * u, r - Math.cos(g) * h), g += Be, e.lineTo(n + Math.sin(g) * u, r - Math.cos(g) * h), g += Be, e.lineTo(n + Math.sin(g) * u, r - Math.cos(g) * h), e.closePath();
				break;
			case "rectRounded":
				l = h * .516, c = h - l, o = Math.cos(g + ze) * c, d = Math.cos(g + ze) * (i ? i / 2 - l : c), s = Math.sin(g + ze) * c, f = Math.sin(g + ze) * (i ? i / 2 - l : c), e.arc(n - d, r - s, l, g - L, g - z), e.arc(n + f, r - o, l, g - z, g), e.arc(n + d, r + s, l, g, g + z), e.arc(n - f, r + o, l, g + z, g + L), e.closePath();
				break;
			case "rect":
				if (!m) {
			...
			case "cross":
				...
				break;
			case "star":
				d = Math.cos(g) * (i ? i / 2 : h), o = Math.cos(g) * h, s = Math.sin(g) * h, f = Math.sin(g) * (i ? i / 2 : h), e.moveTo(n - d, r - s), e.lineTo(n + d, r + s), e.moveTo(n + f, r - o), e.lineTo(n - f, r + o), g += ze, d = Math.cos(g) * (i ? i / 2 : h), o = Math.cos(g) * h, s = Math.sin(g) * h, f = Math.sin(g) * (i ? i / 2 : h), e.moveTo(n - d, r - s), e.lineTo(n + d, r + s), e.moveTo(n + f, r - o), e.lineTo(n - f, r + o);
				break;
			case "line":
...
function tn(e, t, n, r, i, a = {}) {
	...
	for (e.save(), e.font = i.string, Qt(e, a), c = 0; c < o.length; ++c) l = o[c], a.backdrop && en(e, a.backdrop), s && (a.strokeColor && (e.strokeStyle = a.strokeColor), k(a.strokeWidth) || (e.lineWidth = a.strokeWidth), e.strokeText(l, n, r, a.maxWidth)), e.fillText(l, n, r, a.maxWidth), $t(e, n, r, l, a), r += Number(i.lineHeight);
	e.restore();
}
function nn(e, t) {
...
var rn = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/, an = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
function on(e, t) {
	let n = ("" + e).match(rn);
...
function q(e, t) {
	...
	r && !("" + r).match(an) && (console.warn("Invalid font style specified: \"" + r + "\""), r = void 0);
	let i = {
		family: P(e.family, t.family),
		lineHeight: on(P(e.lineHeight, t.lineHeight), n),
		size: n,
		style: r,
		weight: P(e.weight, t.weight),
		string: ""
	};
	return i.string = Bt(i), i;
}
function dn(e, t, n, r) {
	let i = !0, a, o, s;
...
function fn(e, t, n) {
	let { min: r, max: i } = e, a = ye(t, (i - r) / 2), o = (e, t) => n && e === 0 ? 0 : e + t;
	return {
		min: o(r, -Math.abs(a)),
		max: o(i, a)
	};
...
function mn(e, t = [""], n, r, i = () => e[0]) {
	let a = n || e;
	return r === void 0 && (r = An("_fallback", e)), new Proxy({
		...
		_fallback: r,
		_getTarget: i,
		override: (n) => mn([n, ...e], t, a, r)
	}, {
		deleteProperty(t, n) {
			return delete t[n], delete t._keys, delete e[0][n], !0;
		},
		get(n, r) {
			return yn(n, r, () => kn(r, t, e, n));
		},
...
function hn(e, t, n, r) {
	let i = {
		...
		_descriptors: gn(e, r),
		setContext: (t) => hn(e, t, n, r),
		override: (i) => hn(e.override(i), t, n, r)
	};
	return new Proxy(i, {
		deleteProperty(t, n) {
...
function gn(e, t = {
	...
	return {
		...
		isIndexable: Ne(r) ? r : () => r
	};
}
var _n = (e, t) => e ? e + je(t) : t, vn = (e, t) => j(t) && e !== "adapters" && (Object.getPrototypeOf(t) === null || t.constructor === Object);
function yn(e, t, n) {
...
function bn(e, t, n) {
	...
	return Ne(s) && o.isScriptable(t) && (s = xn(t, s, e, n)), A(s) && s.length && (s = Sn(t, s, e, o.isIndexable)), vn(t, s) && (s = hn(s, i, a && a[t], o)), s;
}
function xn(e, t, n, r) {
	...
	s.add(e);
	let c = t(a, o || r);
	return s.delete(e), vn(e, c) && (c = En(i._scopes, i, e, c)), c;
}
function Sn(e, t, n, r) {
...
var wn = (e, t) => e === !0 ? t : typeof e == "string" ? Ae(t, e) : void 0;
function Tn(e, t, n, r, i) {
	for (let a of t) {
		let t = wn(n, a);
		if (t) {
			e.add(t);
			let a = Cn(t._fallback, n, i);
...
function En(e, t, n, r) {
	let i = t._rootScopes, a = Cn(t._fallback, n, r), o = [...e, ...i], s = /* @__PURE__ */ new Set();
	s.add(r);
	let c = Dn(s, o, n, a || n, r);
	return c === null || a !== void 0 && a !== n && (c = Dn(s, o, a, c, r), c === null) ? !1 : mn(Array.from(s), [""], i, a, () => On(t, n, r));
}
function Dn(e, t, n, r, i) {
	for (; n;) n = Tn(e, t, n, r, i);
	return n;
}
function On(e, t, n) {
	let r = e._getTarget();
...
function kn(e, t, n, r) {
	let i;
	for (let a of t) if (i = An(_n(a, e), n), i !== void 0) return vn(e, i) ? En(n, r, e, i) : i;
}
function An(e, t) {
	for (let n of t) {
		if (!n) continue;
...
function jn(e) {
	let t = e._keys;
	return t ||= e._keys = Mn(e._scopes), t;
}
function Mn(e) {
...
function Nn(e, t, n, r) {
	...
	for (s = 0, c = r; s < c; ++s) l = s + n, u = t[l], o[s] = { r: i.parse(Ae(u, a), l) };
	return o;
}
var Pn = 2 ** -52 || 1e-14, Fn = (e, t) => t < e.length && !e[t].skip && e[t], In = (e) => e === "x" ? "y" : "x";
function Ln(e, t, n, r) {
	let i = e.skip ? t : e, a = t, o = n.skip ? t : n, s = Qe(a, i), c = Qe(o, a), l = s / (s + c), u = c / (s + c);
...
function Rn(e, t, n) {
	let r = e.length, i, a, o, s, c, l = Fn(e, 0);
	for (let u = 0; u < r - 1; ++u) if (c = l, l = Fn(e, u + 1), !(!c || !l)) {
		if (He(t[u], 0, Pn)) {
			n[u] = n[u + 1] = 0;
			continue;
		}
...
function zn(e, t, n = "x") {
	let r = In(n), i = e.length, a, o, s, c = Fn(e, 0);
	for (let l = 0; l < i; ++l) {
		if (o = s, s = c, c = Fn(e, l + 1), !s) continue;
		let i = s[n], u = s[r];
		o && (a = (i - o[n]) / 3, s[`cp1${n}`] = i - a, s[`cp1${r}`] = u - a * t[l]), c && (a = (c[n] - i) / 3, s[`cp2${n}`] = i + a, s[`cp2${r}`] = u + a * t[l]);
	}
}
function Bn(e, t = "x") {
	let n = In(t), r = e.length, i = Array(r).fill(0), a = Array(r), o, s, c, l = Fn(e, 0);
	for (o = 0; o < r; ++o) if (s = c, c = l, l = Fn(e, o + 1), c) {
		if (l) {
			let e = l[t] - c[t];
			i[o] = e === 0 ? 0 : (l[n] - c[n]) / e;
		}
...
function Hn(e, t) {
	...
	for (n = 0, r = e.length; n < r; ++n) o = a, a = s, s = n < r - 1 && qt(e[n + 1], t), a && (i = e[n], o && (i.cp1x = Vn(i.cp1x, t.left, t.right), i.cp1y = Vn(i.cp1y, t.top, t.bottom)), s && (i.cp2x = Vn(i.cp2x, t.left, t.right), i.cp2y = Vn(i.cp2y, t.top, t.bottom)));
}
function Un(e, t, n, r, i) {
	let a, o, s, c;
	if (t.spanGaps && (e = e.filter((e) => !e.skip)), t.cubicInterpolationMode === "monotone") Bn(e, i);
	else {
		let n = r ? e[e.length - 1] : e[0];
		for (a = 0, o = e.length; a < o; ++a) s = e[a], c = Ln(n, s, e[Math.min(a + 1, o - +!r) % o], t.tension), s.cp1x = c.previous.x, s.cp1y = c.previous.y, s.cp2x = c.next.x, s.cp2y = c.next.y, n = s;
	}
...
function $n(e, t) {
	...
	let { canvas: n, currentDevicePixelRatio: r } = t, i = qn(n), a = i.boxSizing === "border-box", o = Xn(i, "padding"), s = Xn(i, "border", "width"), { x: c, y: l, box: u } = Qn(e, n), d = o.left + (u && s.left), f = o.top + (u && s.top), { width: p, height: m } = t;
...
function er(e, t, n) {
	...
	if (t === void 0 || n === void 0) {
		...
		if (!a) t = e.clientWidth, n = e.clientHeight;
			...
			let e = a.getBoundingClientRect(), o = qn(a), s = Xn(o, "border", "width"), c = Xn(o, "padding");
			t = e.width - c.width - s.width, n = e.height - c.height - s.height, r = Kn(o.maxWidth, a, "clientWidth"), i = Kn(o.maxHeight, a, "clientHeight");
		}
	}
	return {
		width: t,
...
var tr = (e) => Math.round(e * 10) / 10;
function nr(e, t, n, r) {
	let i = qn(e), a = Xn(i, "margin"), o = Kn(i.maxWidth, e, "clientWidth") || Le, s = Kn(i.maxHeight, e, "clientHeight") || Le, c = er(e, t, n), { width: l, height: u } = c;
	if (i.boxSizing === "content-box") {
		let e = Xn(i, "border", "width"), t = Xn(i, "padding");
		l -= t.width + e.width, u -= t.height + e.height;
	}
	return l = Math.max(0, l - a.width), u = Math.max(0, r ? l / r : u - a.height), l = tr(Math.min(l, o, c.maxWidth)), u = tr(Math.min(u, s, c.maxHeight)), l && !u && (u = tr(l / 2)), (t !== void 0 || n !== void 0) && r && c.height && u > c.height && (u = c.height, l = tr(Math.floor(u * r))), {
		width: l,
		height: u
	};
}
function rr(e, t, n) {
	let r = t || 1, i = tr(e.height * r), a = tr(e.width * r);
	e.height = tr(e.height), e.width = tr(e.width);
	let o = e.canvas;
...
var ir = function() {
	...
	try {
		...
		Wn() && (window.addEventListener("test", null, t), window.removeEventListener("test", null, t));
	} catch {}
	return e;
}();
function ar(e, t) {
	let n = Jn(e, t), r = n && n.match(/^(\d+)(\.\d+)?px$/);
	return r ? +r[1] : void 0;
}
function or(e, t, n, r) {
	return {
...
function cr(e, t, n, r) {
	let i = {
		...
		x: t.cp1x,
		y: t.cp1y
	}, o = or(e, i, n), s = or(i, a, n), c = or(a, t, n);
	return or(or(o, s, n), or(s, c, n), n);
}
var lr = function(e, t) {
	return {
		x(n) {
...
function hr({ start: e, end: t, count: n, loop: r, style: i }) {
	return {
		start: e % n,
		end: t % n,
		loop: r && (t - e + 1) % n === 0,
...
function gr(e, t, n) {
	let { property: r, start: i, end: a } = n, { between: o, normalize: s } = mr(r), c = t.length, { start: l, end: u, loop: d } = e, f, p;
	if (d) {
...
function _r(e, t, n) {
	if (!n) return [e];
	let { property: r, start: i, end: a } = n, o = t.length, { compare: s, between: c, normalize: l } = mr(r), { start: u, end: d, loop: f, style: p } = gr(e, t, n), m = [], h = !1, g = null, _, v, y, b = () => c(i, y, _) && s(i, y) !== 0, x = () => s(a, _) === 0 || c(a, y, _), S = () => h || b(), C = () => !h || x();
	for (let e = u, n = u; e <= d; ++e) v = t[e % o], !v.skip && (_ = l(v[r]), _ !== y && (h = c(_, i, a), g === null && S() && (g = s(_, i) === 0 ? e : n), g !== null && C() && (m.push(hr({
		start: g,
		end: e,
		loop: f,
		count: o,
...
function xr(e, t) {
	...
	if (!i) return [];
	let a = !!e._loop, { start: o, end: s } = yr(n, i, a, r);
	return r === !0 ? Sr(e, [{
		start: o,
		end: s,
		loop: a
	}], n, t) : Sr(e, br(n, o, s < o ? s + i : s, !!e._fullLoop && o === 0 && s === i - 1), n, t);
}
function Sr(e, t, n, r) {
	return !r || !r.setContext || !n ? t : Cr(e, t, n, r);
}
function Cr(e, t, n, r) {
	let i = e._chart.getContext(), a = wr(e.options), { _datasetIndex: o, options: { spanGaps: s } } = e, c = n.length, l = [], u = a, d = t[0].start, f = d;
	function p(e, t, r, i) {
		let a = s ? -1 : 1;
		if (e !== t) {
	...
	for (let e of t) {
		...
		for (f = d + 1; f <= e.end; f++) {
			...
			a = wr(r.setContext(pn(i, {
				...
				p1DataIndex: f % c,
				datasetIndex: o
			}))), Tr(a, u) && p(d, f - 1, e.loop, u), t = s, u = a;
		}
...
function Tr(e, t) {
	...
	let n = [], r = function(e, t) {
		return St(t) ? (n.includes(t) || n.push(t), n.indexOf(t)) : t;
	};
...
function Dr(e, t) {
	...
	return n && r ? {
		...
		right: Er(n, t, "right"),
		top: Er(r, t, "top"),
		bottom: Er(r, t, "bottom")
	} : t;
}
function Or(e, t) {
	let n = t._clip;
	if (n.disabled) return !1;
	let r = Dr(t, e.chartArea);
	return {
...
var kr = /* #__PURE__ */ new class {
	...
	_refresh() {
		this._request ||= (this._running = !0, dt.call(window, () => {
	...
	color(e, t, n) {
		let r = Ct(e || Ar), i = r.valid && Ct(t || Ar);
	...
	constructor(e, t, n, r) {
		...
		this._active = !0, this._fn = e.fn || jr[e.type || typeof a], this._easing = xt[e.easing] || xt.linear, this._start = Math.floor(Date.now() + (e.delay || 0)), this._duration = this._total = Math.floor(e.duration), this._loop = !!e.loop, this._target = t, this._prop = n, this._from = a, this._to = r, this._promises = void 0;
	}
	active() {
		return this._active;
	}
	update(e, t, n) {
		if (this._active) {
			...
			this._start = n, this._duration = Math.floor(Math.max(a, e.duration)), this._total += i, this._loop = !!e.loop, this._to = dn([
				e.to,
				t,
				r,
				e.from
	...
	_animateOptions(e, t) {
		let n = t.options, r = Fr(e, n);
		if (!r) return [];
		let i = this._createAnimations(r, n);
		return n.$shared && Pr(e.options.$animations, n).then(() => {
			e.options = n;
		}, () => {}), i;
	}
	...
	update(e, t) {
		...
		if (n.length) return kr.add(this._chart, n), !0;
	}
};
function Pr(e, t) {
...
function qr(e, t) {
	let { chart: n, _cachedMeta: r } = e, i = n._stacks ||= {}, { iScale: a, vScale: o, index: s } = r, c = a.axis, l = o.axis, u = Ur(a, o, r), d = t.length, f;
	for (let e = 0; e < d; ++e) {
		let n = t[e], { [c]: a, [l]: d } = n, p = n._stacks ||= {};
		f = p[l] = Gr(i, u, a), f[s] = d, f._top = Kr(f, o, !0, r.type), f._bottom = Kr(f, o, !1, r.type);
		let m = f._visualValues || (f._visualValues = {});
		m[s] = d;
	}
}
function Jr(e, t) {
...
var Qr = (e) => e === "reset" || e === "none", $r = (e, t) => t ? e : Object.assign({}, e), ei = (e, t, n) => e && !t.hidden && t._stacked && {
	keys: zr(n, !0),
	values: null
}, ti = class {
	static defaults = {};
	...
	updateIndex(e) {
		this.index !== e && Zr(this._cachedMeta), this.index = e;
	}
	linkScales() {
		let e = this.chart, t = this._cachedMeta, n = this.getDataset(), r = (e, t, n, r) => e === "x" ? t : e === "r" ? r : n, i = t.xAxisID = P(n.xAxisID, Jr(e, "x")), a = t.yAxisID = P(n.yAxisID, Jr(e, "y")), o = t.rAxisID = P(n.rAxisID, Jr(e, "r")), s = t.indexAxis, c = t.iAxisID = r(s, i, a, o), l = t.vAxisID = r(s, a, i, o);
	...
	_destroy() {
		let e = this._cachedMeta;
		this._data && lt(this._data, this), e._stacked && Zr(e);
	}
	_dataCheck() {
		...
		if (j(t)) {
			...
			t && Object.isExtensible(t) && ct(t, this), this._syncList = [], this._data = t;
		}
	}
	addElements() {
		let e = this._cachedMeta;
	...
	buildOrUpdateElements(e) {
		...
		this._dataCheck();
		let i = t._stacked;
		t._stacked = Hr(t.vScale, t), t.stack !== n.stack && (r = !0, Zr(t), t.stack = n.stack), this._resyncElements(e), (r || i !== t._stacked) && (qr(this, t._parsed), t._stacked = Hr(t.vScale, t));
	}
	configure() {
	...
	parse(e, t) {
		let { _cachedMeta: n, _data: r } = this, { iScale: i, _stacked: a } = n, o = i.axis, s = e === 0 && t === r.length || n._sorted, c = e > 0 && n._parsed[e - 1], l, u, d;
	...
	updateRangeFromParsed(e, t, n, r) {
		...
		r && o && (r.values = o, a = Br(r, i, this._cachedMeta.index)), e.min = Math.min(e.min, a), e.max = Math.max(e.max, a);
	}
	getMinMax(e, t) {
		let n = this._cachedMeta, r = n._parsed, i = n._sorted && e === n.iScale, a = r.length, o = this._getOtherScale(e), s = ei(t, n, this.chart), c = {
			min: Infinity,
			max: -Infinity
		}, { min: l, max: u } = Wr(o), d, f;
		function p() {
			f = r[d];
			let t = f[o.axis];
	...
	_update(e) {
		let t = this._cachedMeta;
		this.update(e || "default"), t._clip = Rr(P(this.options.clip, Lr(t.xScale, t.yScale, this.getMaxOverflow())));
	}
	update(e) {}
	draw() {
	...
	getContext(e, t, n) {
		...
		if (e >= 0 && e < this._cachedMeta.data.length) {
			...
			i = t.$context ||= Xr(this.getContext(), e, t), i.parsed = this.getParsed(e), i.raw = r.data[e], i.index = i.dataIndex = e;
		} else i = this.$context ||= Yr(this.chart.getContext(), this.index), i.dataset = r, i.index = i.datasetIndex = this.index;
	...
	_resolveElementOptions(e, t = "default", n) {
		let r = t === "active", i = this._cachedDataOpts, a = e + "-" + t, o = i[a], s = this.enableOptionSharing && Me(n);
		if (o) return $r(o, s);
		...
		return p.$shared && (p.$shared = s, i[a] = Object.freeze($r(p, s))), p;
	}
	...
	includeOptions(e, t) {
		return !t || Qr(e) || this.chart._animationsDisabled;
	}
	...
	updateElement(e, t, n, r) {
		Qr(r) ? Object.assign(e, n) : this._resolveAnimations(t, r).update(e, n);
	}
	updateSharedOptions(e, t, n) {
		e && !Qr(t) && this._resolveAnimations(void 0, t).update(e, n);
	}
	_setStyle(e, t, n, r) {
		e.active = r;
...
function ri(e) {
	let t = e.iScale, n = ni(t, e.type), r = t._length, i, a, o, s, c = () => {
		o !== 32767 && o !== -32768 && (Me(s) && (r = Math.min(r, Math.abs(o - s) || r)), s = o);
	};
...
function si(e, t, n, r) {
	return A(e) ? oi(e, t, n, r) : t[n.axis] = n.parse(e, r), t;
}
function ci(e, t, n, r) {
	let i = e.iScale, a = e.vScale, o = i.getLabels(), s = i === a, c = [], l, u, d, f;
	for (l = n, u = n + r; l < u; ++l) f = t[l], d = {}, d[i.axis] = s || i.parse(o[l], l), c.push(si(f, d, a, l));
	return c;
}
function li(e) {
...
function fi(e, t, n, r) {
	...
	let { start: o, end: s, reverse: c, top: l, bottom: u } = di(e);
	i === "middle" && n && (e.enableBorderRadius = !0, (n._top || 0) === r ? i = l : (n._bottom || 0) === r ? i = u : (a[pi(u, o, s, c)] = !0, i = l)), a[pi(i, o, s, c)] = !0, e.borderSkipped = a;
}
function pi(e, t, n, r) {
	return r ? (e = mi(e, t, n), e = hi(e, n, t)) : e = hi(e, t, n), e;
}
function mi(e, t, n) {
...
function gi(e, { inflateAmount: t }, n) {
	e.inflateAmount = t === "auto" ? n === 1 ? .33 : 0 : t;
}
var _i = class extends ti {
	static id = "bar";
	static defaults = {
	...
	parseObjectData(e, t, n, r) {
		...
		for (d = n, f = n + r; d < f; ++d) m = t[d], p = {}, p[i.axis] = i.parse(Ae(m, c), d), u.push(si(Ae(m, l), p, a, d));
		return u;
	}
	updateRangeFromParsed(e, t, n, r) {
	...
	getLabelAndValue(e) {
		let { iScale: t, vScale: n } = this._cachedMeta, r = this.getParsed(e), i = r._custom, a = li(i) ? "[" + i.start + ", " + i.end + "]" : "" + n.getLabelForValue(r[n.axis]);
		return {
	...
	updateElements(e, t, n, r) {
		...
		for (let f = t; f < t + n; f++) {
			let t = this.getParsed(f), n = i || k(t[o.axis]) ? {
				...
				horizontal: c,
				base: n.base,
				enableBorderRadius: !m || li(t._custom) || a === m._top || a === m._bottom,
				x: c ? n.head : p.center,
				y: c ? p.center : n.head,
			...
			fi(h, g, m, a), gi(h, g, l.ratio), this.updateElement(e[f], f, h, r);
		}
	}
	_getStacks(e, t) {
	...
	_calculateBarValuePixels(e) {
		let { _cachedMeta: { vScale: t, _stacked: n, index: r }, options: { base: i, minBarLength: a } } = this, o = i || 0, s = this.getParsed(e), c = s._custom, l = li(c), u = s[t.axis], d = 0, f = n ? this.applyStack(t, s, n) : u, p, m;
	...
	_calculateBarIndexPixels(e, t) {
		...
		if (t.grouped) {
			let n = i ? this._getStackCount(e) : t.stackCount, l = r.barThickness === "flex" ? ai(e, t, r, n * c) : ii(e, t, r, n * c), u = this.chart.options.indexAxis === "x" ? this.getDataset().xAxisID : this.getDataset().yAxisID, d = this._getAxis().indexOf(P(u, this.getFirstScaleIdForIndexAxis())), f = this._getStackIndex(this.index, this._cachedMeta.stack, i ? e : void 0) + d;
...
function yi(e, t, n) {
	let r = 1, i = 1, a = 0, o = 0;
	if (t < R) {
		let s = e, c = s + t, l = Math.cos(s), u = Math.sin(s), d = Math.cos(c), f = Math.sin(c), p = (e, t, r) => et(e, s, c, !0) ? 1 : Math.max(t, t * n, r, r * n), m = (e, t, r) => et(e, s, c, !0) ? -1 : Math.min(t, t * n, r, r * n), h = p(0, l, d), g = p(z, u, f), _ = m(L, l, d), v = m(L + z, u, f);
...
var bi = class extends ti {
	...
	getLabelAndValue(e) {
		let t = this._cachedMeta, n = this.chart, r = n.data.labels || [], i = jt(t._parsed[e], n.options.locale);
		return {
			label: r[e] || "",
			value: i
		};
	...
	update(e) {
		let t = this._cachedMeta, { dataset: n, data: r = [], _dataset: i } = t, a = this.chart._animationsDisabled, { start: o, count: s } = gt(t, r, a);
		this._drawStart = o, this._drawCount = s, _t(t) && (o = 0, s = r.length), n._chart = this.chart, n._datasetIndex = this.index, n._decimated = !!i._decimated, n.points = r;
	...
	updateElements(e, t, n, r) {
		let i = r === "reset", { iScale: a, vScale: o, _stacked: s, _dataset: c } = this._cachedMeta, { sharedOptions: l, includeOptions: u } = this._getSharedOptions(t, r), d = a.axis, f = o.axis, { spanGaps: p, segment: m } = this.options, h = Ke(p) ? p : Infinity, g = this.chart._animationsDisabled || i || r === "none", _ = t + n, v = e.length, y = t > 0 && this.getParsed(t - 1);
		for (let n = 0; n < v; ++n) {
			let p = e[n], v = g ? p : {};
			if (n < t || n >= _) {
				v.skip = !0;
	...
	getLabelAndValue(e) {
		let t = this._cachedMeta, n = this.chart, r = n.data.labels || [], i = jt(t._parsed[e].r, n.options.locale);
		return {
			label: r[e] || "",
			value: i
		};
	...
	LineController: xi,
	PieController: Ci,
	PolarAreaController: Si,
	RadarController: wi,
	ScatterController: class extends ti {
		static id = "scatter";
		static defaults = {
			datasetElementType: !1,
			dataElementType: "point",
		...
		update(e) {
			let t = this._cachedMeta, { data: n = [] } = t, r = this.chart._animationsDisabled, { start: i, count: a } = gt(t, n, r);
			if (this._drawStart = i, this._drawCount = a, _t(t) && (i = 0, a = n.length), this.options.showLine) {
		...
		updateElements(e, t, n, r) {
			let i = r === "reset", { iScale: a, vScale: o, _stacked: s, _dataset: c } = this._cachedMeta, l = this.resolveDataElementOptions(t, r), u = this.getSharedOptions(l), d = this.includeOptions(r, u), f = a.axis, p = o.axis, { spanGaps: m, segment: h } = this.options, g = Ke(m) ? m : Infinity, _ = this.chart._animationsDisabled || i || r === "none", v = t > 0 && this.getParsed(t - 1);
			for (let l = t; l < t + n; ++l) {
...
function ki(e, t, n, r, i) {
	...
	for (let e = 0, n = a.length; e < n; ++e) {
		let { index: n, data: s } = a[e], { lo: c, hi: l } = Oi(a[e], t, o, i);
		for (let e = c; e <= l; ++e) {
			let t = s[e];
			t.skip || r(t, n, e);
		}
...
function ji(e, t, n, r, i) {
	let a = [];
	return !i && !e.isPointInArea(t) || ki(e, n, t, function(n, o, s) {
...
function Mi(e, t, n, r) {
	let i = [];
	function a(e, n, a) {
		let { startAngle: o, endAngle: s } = e.getProps(["startAngle", "endAngle"], r), { angle: c } = Ze(e, {
			x: t.x,
			y: t.y
		});
		et(c, o, s) && i.push({
...
function Pi(e, t, n, r, i, a) {
	return !a && !e.isPointInArea(t) ? [] : n === "r" && !r ? Mi(e, t, n, i) : Ni(e, t, n, r, i, a);
}
function Fi(e, t, n, r, i) {
	let a = [], o = n === "x" ? "inXRange" : "inYRange", s = !1;
	return ki(e, n, t, (e, r, c) => {
...
var Ii = {
	...
	modes: {
		index(e, t, n, r) {
			let i = $n(t, e), a = n.axis || "x", o = n.includeInvisible || !1, s = n.intersect ? ji(e, i, a, r, o) : Pi(e, i, a, !1, r, o), c = [];
		...
		dataset(e, t, n, r) {
			let i = $n(t, e), a = n.axis || "xy", o = n.includeInvisible || !1, s = n.intersect ? ji(e, i, a, r, o) : Pi(e, i, a, !1, r, o);
			if (s.length > 0) {
		...
		point(e, t, n, r) {
			return ji(e, $n(t, e), n.axis || "xy", r, n.includeInvisible || !1);
		},
		nearest(e, t, n, r) {
			let i = $n(t, e), a = n.axis || "xy", o = n.includeInvisible || !1;
			return Pi(e, i, a, n.intersect, r, o);
		},
		x(e, t, n, r) {
			return Fi(e, $n(t, e), "x", n.intersect, r);
		},
		y(e, t, n, r) {
			return Fi(e, $n(t, e), "y", n.intersect, r);
		}
	}
}, Li = [
	"left",
...
function zi(e, t) {
	return e.filter((e) => Li.indexOf(e.pos) === -1 && e.box.axis === t);
}
function Bi(e, t) {
	return e.sort((e, n) => {
		let r = t ? n : e, i = t ? e : n;
...
function Ui(e, t) {
	let n = Hi(e), { vBoxMaxWidth: r, hBoxMaxHeight: i } = t, a, o, s;
...
function Wi(e) {
	let t = Vi(e), n = Bi(t.filter((e) => e.box.fullSize), !0), r = Bi(Ri(t, "left"), !0), i = Bi(Ri(t, "right")), a = Bi(Ri(t, "top"), !0), o = Bi(Ri(t, "bottom")), s = zi(t, "x"), c = zi(t, "y");
	return {
		fullSize: n,
...
function qi(e, t, n, r) {
	...
	a.getPadding && Ki(o, a.getPadding());
	let s = Math.max(0, t.outerWidth - Gi(o, e, "left", "right")), c = Math.max(0, t.outerHeight - Gi(o, e, "top", "bottom")), l = s !== e.w, u = c !== e.h;
...
function Xi(e, t, n, r) {
	...
	for (a = 0, o = e.length, l = 0; a < o; ++a) {
		s = e[a], c = s.box, c.update(s.width || t.w, s.height || t.h, Yi(s.horizontal, t));
		let { same: o, other: d } = qi(t, n, s, r);
		l |= o && i.length, u ||= d, c.fullSize || i.push(s);
	}
	return l && Xi(i, t, n, r) || u;
}
...
function Qi(e, t, n, r) {
	...
	for (let s of e) {
		...
		if (s.horizontal) {
			...
			Me(c.start) && (o = c.start), e.fullSize ? Zi(e, i.left, o, n.outerWidth - i.right - i.left, a) : Zi(e, t.left + c.placed, o, r, a), c.start = o, c.placed += r, o = e.bottom;
		} else {
			let r = t.h * l, o = c.size || e.width;
			Me(c.start) && (a = c.start), e.fullSize ? Zi(e, a, i.top, o, n.outerHeight - i.bottom - i.top) : Zi(e, a, t.top + c.placed, o, r), c.start = a, c.placed += r, a = e.right;
		}
	}
	t.x = a, t.y = o;
}
var J = {
	...
	update(e, t, n, r) {
		if (!e) return;
		let i = K(e.options.layout.padding), a = Math.max(t - i.width, 0), o = Math.max(n - i.height, 0), s = Wi(e.boxes), c = s.vertical, l = s.horizontal;
		I(e.boxes, (e) => {
		...
		Xi(s.fullSize, p, d, m), Xi(c, p, d, m), Xi(l, p, d, m) && Xi(c, p, d, m), Ji(p), Qi(s.leftAndTop, p, d, m), p.x += p.w, p.y += p.h, Qi(s.rightAndBottom, p, d, m), e.chartArea = {
			left: p.left,
			top: p.top,
			right: p.left + p.w,
			bottom: p.top + p.h,
...
function ia(e, t) {
	...
	} }, n.display = n.display || "block", n.boxSizing = n.boxSizing || "border-box", ra(i)) {
		let t = ar(e, "width");
		t !== void 0 && (e.width = t);
	}
	if (ra(r)) {
...
var aa = ir ? { passive: !0 } : !1;
function oa(e, t, n) {
	e && e.addEventListener(t, n, aa);
}
function sa(e, t, n) {
	e && e.canvas && e.canvas.removeEventListener(t, n, aa);
}
function ca(e, t) {
	let n = na[e.type] || e.type, { x: r, y: i } = $n(e, t);
	return {
		type: n,
		chart: t,
		native: e,
...
function ua(e, t, n) {
	let r = e.canvas, i = new MutationObserver((e) => {
		let t = !1;
		for (let n of e) t ||= la(n.addedNodes, r), t &&= !la(n.removedNodes, r);
		t && n();
	});
...
function da(e, t, n) {
	let r = e.canvas, i = new MutationObserver((e) => {
		let t = !1;
		for (let n of e) t ||= la(n.removedNodes, r), t &&= !la(n.addedNodes, r);
		t && n();
	});
	return i.observe(document, {
		childList: !0,
...
var fa = /* @__PURE__ */ new Map(), pa = 0;
function ma() {
	let e = window.devicePixelRatio;
	e !== pa && (pa = e, fa.forEach((t, n) => {
		n.currentDevicePixelRatio !== e && t();
	}));
}
function ha(e, t) {
	fa.size || window.addEventListener("resize", ma), fa.set(e, t);
}
function ga(e) {
	fa.delete(e), fa.size || window.removeEventListener("resize", ma);
}
function _a(e, t, n) {
	let r = e.canvas, i = r && Gn(r);
	if (!i) return;
	let a = ft((e, t) => {
		let r = i.clientWidth;
...
function va(e, t, n) {
	n && n.disconnect(), t === "resize" && ga(e);
}
function ya(e, t, n) {
	let r = e.canvas, i = ft((t) => {
		e.ctx !== null && n(ca(t, e));
	}, e);
	return oa(r, t, i), i;
}
var ba = class extends $i {
	acquireContext(e, t) {
		...
		return n && n.canvas === e ? (ia(e, t), n) : null;
	}
	releaseContext(e) {
		let t = e.canvas;
		if (!t[ta]) return !1;
...
function xa(e) {
	return !Wn() || typeof OffscreenCanvas < "u" && e instanceof OffscreenCanvas ? ea : ba;
}
var Sa = class {
	static defaults = {};
...
function Ca(e, t) {
	let n = e.options.ticks, r = wa(e), i = Math.min(n.maxTicksLimit || r, r), a = n.major.enabled ? Ea(t) : [], o = a.length, s = a[0], c = a[o - 1], l = [];
	if (o > i) return Da(t, l, a, o / i), l;
	let u = Ta(a, t, i);
	if (o > 0) {
		let e, n, r = o > 1 ? Math.round((c - s) / (o - 1)) : null;
		for (Oa(t, l, u, k(r) ? 0 : s - r, s), e = 0, n = o - 1; e < n; e++) Oa(t, l, u, a[e], a[e + 1]);
		return Oa(t, l, u, c, k(r) ? t.length : c + r), l;
	}
	return Oa(t, l, u), l;
}
function wa(e) {
...
var Aa = (e) => e === "left" ? "right" : e === "right" ? "left" : e, ja = (e, t, n) => t === "top" || t === "left" ? e[t] + n : e[t] - n, Ma = (e, t) => Math.min(t || e, e);
function Na(e, t) {
...
function Ba(e, t, n) {
	let r = mt(e);
	return (n && t !== "right" || !n && t === "right") && (r = Aa(r)), r;
}
function Va(e, t, n, r) {
	...
	if (e.isHorizontal()) {
		...
		} else m = n === "center" ? (l.bottom + l.top) / 2 + h - t : ja(e, n, t);
		f = s - a;
	} else {
		if (j(n)) {
			let e = Object.keys(n)[0], r = n[e];
			p = u[e].getPixelForValue(r) - g + t;
		} else p = n === "center" ? (l.left + l.right) / 2 - g + t : ja(e, n, t);
...
var Ha = class e extends Sa {
	...
	calculateLabelRotation() {
		let e = this.options, t = e.ticks, n = Ma(this.ticks.length, e.ticks.maxTicksLimit), r = t.minRotation || 0, i = t.maxRotation, a = r, o, s, c;
		...
		o = e.offset ? this.maxWidth / n : f / (n - 1), u + 6 > o && (o = f / (n - (e.offset ? .5 : 1)), s = this.maxHeight - Ia(e.grid) - t.padding - La(e.title, this.chart.options.font), c = Math.sqrt(u * u + d * d), a = Ye(Math.min(Math.asin(U((l.highest.height + 6) / o, -1, 1)), Math.asin(U(s / c, -1, 1)) - Math.asin(U(d / c, -1, 1)))), a = Math.max(r, Math.min(i, a))), this.labelRotation = a;
	}
	...
	fit() {
		...
		if (a) {
			let a = La(r, t.options.font);
			if (o ? (e.width = this.maxWidth, e.height = Ia(i) + a) : (e.height = this.maxHeight, e.width = Ia(i) + a), n.display && this.ticks.length) {
	...
	_getLabelSizes() {
		...
		if (!e) {
			...
			t < n.length && (n = Na(n, t)), this._labelSizes = e = this._computeLabelSizes(n, n.length, this.options.ticks.maxTicksLimit);
		}
		return e;
	}
	_computeLabelSizes(e, t, n) {
		let { ctx: r, _longestTextCache: i } = this, a = [], o = [], s = Math.floor(t / Ma(t, n)), c = 0, l = 0, u, d, f, p, m, h, g, _, v, y, b;
		for (u = 0; u < t; u += s) {
			if (p = e[u].label, m = this._resolveTickFontOptions(u), r.font = h = m.string, g = i[h] = i[h] || {
				data: {},
				gc: []
			}, _ = m.lineHeight, v = y = 0, !k(p) && !A(p)) v = Vt(r, g.data, g.gc, v, p), y = _;
			else if (A(p)) for (d = 0, f = p.length; d < f; ++d) b = p[d], !k(b) && !A(b) && (v = Vt(r, g.data, g.gc, v, b), y += _);
	...
	getPixelForDecimal(e) {
		...
		return tt(this._alignToPixels ? Ut(this.chart, t, 0) : t);
	}
	...
	getContext(e) {
		...
		if (e >= 0 && e < t.length) {
			let n = t[e];
			return n.$context ||= za(this.getContext(), e, n);
		}
		return this.$context ||= Ra(this.chart.getContext(), this);
	}
	_tickSize() {
	...
	_computeGridLineItems(e) {
		let t = this.axis, n = this.chart, r = this.options, { grid: i, position: a, border: o } = r, s = i.offset, c = this.isHorizontal(), l = this.ticks.length + +!!s, u = Ia(i), d = [], f = o.setContext(this.getContext()), p = f.display ? f.width : 0, m = p / 2, h = function(e) {
			return Ut(n, e, p);
		...
		for (_ = 0; _ < l; _ += O) {
			...
			v = Pa(this, _, s), v !== void 0 && (y = Ut(n, v, a), c ? b = S = w = E = y : x = C = T = D = y, d.push({
				tx1: b,
				ty1: x,
				tx2: S,
				ty2: C,
	...
	_computeLabelItems(e) {
		let t = this.axis, n = this.options, { position: r, ticks: i } = n, a = this.isHorizontal(), o = this.ticks, { align: s, crossAlign: c, padding: l, mirror: u } = i, d = Ia(n.grid), f = d + l, p = u ? -l : f, m = -V(this.labelRotation), h = [], g, _, v, y, b, x, S, C, w, T, E, D, ee = "middle";
			...
			if (e.showLabelBackdrop) {
				...
				switch (S) {
					...
					case "right":
						a -= r;
						break;
					case "inner": g === _ - 1 ? a -= r : g > 0 && (a -= r / 2);
				}
				f = {
					left: a,
					top: i,
	...
	drawBorder() {
		...
		this.isHorizontal() ? (c = Ut(e, this.left, a) - a / 2, l = Ut(e, this.right, o) + o / 2, u = d = s) : (u = Ut(e, this.top, a) - a / 2, d = Ut(e, this.bottom, o) + o / 2, c = l = s), t.save(), t.lineWidth = i.width, t.strokeStyle = i.color, t.beginPath(), t.moveTo(c, u), t.lineTo(l, d), t.stroke(), t.restore();
	}
	drawLabels(e) {
	...
	drawTitle() {
		...
		let { titleX: c, titleY: l, maxWidth: u, rotation: d } = Va(this, s, t, o);
		tn(e, n.text, 0, 0, i, {
			color: n.color,
			maxWidth: u,
			rotation: d,
	...
	register(e) {
		...
		return i in r ? a : (r[i] = e, Wa(e, a, n), this.override && G.override(e.id, e.overrides), a);
	}
	get(e) {
		return this.items[e];
	}
	unregister(e) {
		...
		n in t && delete t[n], r && n in G[r] && (delete G[r][n], this.override && delete It[n]);
	}
};
function Wa(e, t, n) {
	let r = we(Object.create(null), [
		n ? G.get(n) : {},
		G.get(t),
		e.defaults
	]);
	G.set(t, r), e.defaultRoutes && Ga(t, e.defaultRoutes), e.descriptors && G.describe(t, e.descriptors);
}
function Ga(e, t) {
...
var Y = /* #__PURE__ */ new class {
	constructor() {
		this.controllers = new Ua(ti, "datasets", !0), this.elements = new Ua(Sa, "elements"), this.plugins = new Ua(Object, "plugins"), this.scales = new Ua(Ha, "scales"), this._typedRegistries = [
			this.controllers,
			this.scales,
			this.elements
		];
	...
	_createDescriptors(e, t) {
		let n = e && e.config, r = P(n.options && n.options.plugins, {}), i = Ja(n);
		return r === !1 && !t ? [] : Xa(e, i, r, t);
	}
...
function Xa(e, { plugins: t, localIds: n }, r, i) {
	let a = [], o = e.getContext();
	for (let s of t) {
		let t = s.id, c = Ya(r[t], i);
		c !== null && a.push({
			plugin: s,
			options: Za(e.config, {
				plugin: s,
...
function Za(e, { plugin: t, local: n }, r, i) {
...
function ro(e, ...t) {
	if (to(e)) return e;
	for (let n of t) {
		let t = n.axis || no(n.position) || e.length > 1 && to(e[0].toLowerCase());
		if (t) return t;
	}
...
function ao(e, t) {
	if (t.data && t.data.datasets) {
		...
		if (n.length) return io(e, "x", n[0]) || io(e, "y", n[0]);
	}
	return {};
}
function oo(e, t) {
	let n = It[e.type] || { scales: {} }, r = t.scales || {}, i = Qa(e.type, t), a = Object.create(null);
	return Object.keys(r).forEach((t) => {
		...
		let s = ro(t, o, ao(t, e), G.scales[o.type]), c = eo(s, i), l = n.scales || {};
		a[t] = Te(Object.create(null), [
			{ axis: s },
			o,
			l[s],
			l[c]
		...
		let i = n.type || e.type, o = n.indexAxis || Qa(i, t), s = (It[i] || {}).scales || {};
		Object.keys(s).forEach((e) => {
			let t = $a(e, o), i = n[t + "AxisID"] || t;
			a[i] = a[i] || Object.create(null), Te(a[i], [
				{ axis: t },
				r[i],
				s[e]
			]);
		...
		let t = a[e];
		Te(t, [G.scales[t.type], G.scale]);
	}), a;
}
function so(e) {
	let t = e.options ||= {};
	t.plugins = P(t.plugins, {}), t.scales = oo(e, t);
}
function co(e) {
	return e ||= {}, e.datasets = e.datasets || [], e.labels = e.labels || [], e;
}
function lo(e) {
	return e ||= {}, e.data = co(e.data), so(e), e;
}
var uo = /* @__PURE__ */ new Map(), fo = /* @__PURE__ */ new Set();
function po(e, t) {
	let n = uo.get(e);
	return n || (n = t(), uo.set(e, n), fo.add(n)), n;
}
var mo = (e, t, n) => {
	let r = Ae(t, n);
	r !== void 0 && e.add(r);
	...
	constructor(e) {
		this._config = lo(e), this._scopeCache = /* @__PURE__ */ new Map(), this._resolverCache = /* @__PURE__ */ new Map();
	}
	get platform() {
	...
	update() {
		let e = this._config;
		this.clearCache(), so(e);
	}
	clearCache() {
		this._scopeCache.clear(), this._resolverCache.clear();
	}
	datasetScopeKeys(e) {
		return po(e, () => [[`datasets.${e}`, ""]]);
	}
	datasetAnimationScopeKeys(e, t) {
		return po(`${e}.transition.${t}`, () => [[`datasets.${e}.transitions.${t}`, `transitions.${t}`], [`datasets.${e}`, ""]]);
	}
	...
	pluginScopeKeys(e) {
		...
		return po(`${n}-plugin-${t}`, () => [[`plugins.${t}`, ...e.additionalOptionScopes || []]]);
	}
	_cachedScopes(e, t) {
	...
	getOptionScopes(e, t, n) {
		...
		t.forEach((t) => {
			e && (s.add(e), t.forEach((t) => mo(s, e, t))), t.forEach((e) => mo(s, r, e)), t.forEach((e) => mo(s, It[i] || {}, e)), t.forEach((e) => mo(s, G, e)), t.forEach((e) => mo(s, Lt, e));
		});
		let c = Array.from(s);
		return c.length === 0 && c.push(Object.create(null)), fo.has(t) && a.set(t, c), c;
	}
	chartOptionScopes() {
	...
	resolveNamedOptions(e, t, n, r = [""]) {
		let i = { $shared: !0 }, { resolver: a, subPrefixes: o } = go(this._resolverCache, e, r), s = a;
		if (vo(a, t)) {
			i.$shared = !1, n = Ne(n) ? n() : n;
	...
	createResolver(e, t, n = [""], r) {
		let { resolver: i } = go(this._resolverCache, e, n);
		return j(t) ? hn(i, t, void 0, r) : i;
	}
};
function go(e, t, n) {
	let r = e.get(t);
...
var _o = (e) => j(e) && Object.getOwnPropertyNames(e).some((t) => Ne(e[t]));
function vo(e, t) {
	let { isScriptable: n, isIndexable: r } = gn(e);
	for (let i of t) {
		let t = n(i), a = r(i), o = (a || t) && e[i];
		if (t && (Ne(o) || _o(o)) || a && A(o)) return !0;
	}
	return !1;
}
var yo = "4.5.1", bo = [
...
function xo(e, t) {
	return e === "top" || e === "bottom" || bo.indexOf(e) === -1 && t === "x";
}
function So(e, t) {
	return function(n, r) {
...
function To(e) {
	return Wn() && typeof e == "string" ? e = document.getElementById(e) : e && e.length && (e = e[0]), e && e.canvas && (e = e.canvas), e;
}
var Eo = {}, Do = (e) => {
	let t = To(e);
	return Object.values(Eo).filter((e) => e.canvas === t).pop();
};
function Oo(e, t, n) {
	let r = Object.keys(e);
	for (let i of r) {
...
var Ao = class {
	...
	constructor(e, t) {
		let n = this.config = new ho(t), r = To(e), i = Do(r);
		...
		this.platform = new (n.platform || (xa(r)))(), this.platform.updateConfig(n);
		let o = this.platform.acquireContext(r, a.aspectRatio), s = o && o.canvas, c = s && s.height, l = s && s.width;
		if (this.id = _e(), this.ctx = o, this.canvas = s, this.width = l, this.height = c, this._options = a, this._aspectRatio = this.aspectRatio, this._layers = [], this._metasets = [], this._stacks = void 0, this.boxes = [], this.currentDevicePixelRatio = void 0, this.chartArea = void 0, this._active = [], this._lastEvent = void 0, this._listeners = {}, this._responsiveListeners = void 0, this._sortedMetasets = [], this.scales = {}, this._plugins = new qa(), this.$proxies = {}, this._hiddenIndices = {}, this.attached = !1, this._animationsDisabled = void 0, this.$context = void 0, this._doResize = pt((e) => this.update(e), a.resizeDelay || 0), this._dataChanges = [], Eo[this.id] = this, !o || !s) {
			console.error("Failed to create chart: can't acquire context from the given item");
			return;
		}
		kr.listen(this, "complete", Co), kr.listen(this, "progress", wo), this._initialize(), this.attached && this.update();
	}
	get aspectRatio() {
	...
	_initialize() {
		return this.notifyPlugins("beforeInit"), this.options.responsive ? this.resize() : rr(this, this.options.devicePixelRatio), this.bindEvents(), this.notifyPlugins("afterInit"), this;
	}
	clear() {
		return Wt(this.canvas, this.ctx), this;
	}
	stop() {
		return kr.stop(this), this;
	}
	resize(e, t) {
		kr.running(this) ? this._resizeBeforeDraw = {
			width: e,
			height: t
		} : this._resize(e, t);
	}
	_resize(e, t) {
		...
		this.width = a.width, this.height = a.height, this._aspectRatio = this.aspectRatio, rr(this, o, !0) && (this.notifyPlugins("resize", { size: a }), F(n.onResize, [this, a], this), this.attached && this._doResize(s) && this.render());
	}
	ensureScalesHaveIDs() {
	...
	buildOrUpdateScales() {
		...
		t && (i = i.concat(Object.keys(t).map((e) => {
			let n = t[e], r = ro(e, n), i = r === "r", a = r === "x";
			return {
				options: n,
			...
			let i = t.options, a = i.id, o = ro(a, i), s = P(i.type, t.dtype);
			(i.position === void 0 || xo(i.position, o) !== xo(t.dposition)) && (i.position = t.dposition), r[a] = !0;
			let c = null;
	...
	_updateMetasets() {
		...
		this._sortedMetasets = e.slice(0).sort(So("order", "index"));
	}
	...
	buildOrUpdateControllers() {
		...
		for (this._removeUnreferencedMetasets(), n = 0, r = t.length; n < r; n++) {
			...
			if (i.type && i.type !== a && (this._destroyDatasetMeta(n), i = this.getDatasetMeta(n)), i.type = a, i.indexAxis = r.indexAxis || Qa(a, this.options), i.order = r.order || 0, i.index = n, i.label = "" + r.label, i.visible = this.isDatasetVisible(n), i.controller) i.controller.updateIndex(n), i.controller.linkScales();
			else {
	...
	update(e) {
		...
		a = this._minPadding = n.layout.autoPadding ? a : 0, this._updateLayout(a), r || I(i, (e) => {
			e.reset();
		}), this._updateDatasets(e), this.notifyPlugins("afterUpdate", { mode: e }), this._layers.sort(So("z", "_idx"));
	...
	_checkEventBindings() {
		let e = this.options;
		(!Pe(new Set(Object.keys(this._listeners)), new Set(e.events)) || !!this._responsiveListeners !== e.responsive) && (this.unbindEvents(), this.bindEvents());
	}
	_updateHiddenIndices() {
		let { _hiddenIndices: e } = this, t = this._getUniformDataChanges() || [];
		for (let { method: n, start: r, count: i } of t) Oo(e, r, n === "_removeElements" ? -i : i);
	}
	_getUniformDataChanges() {
		...
		for (let e = 1; e < t; e++) if (!Pe(r, n(e))) return;
	...
	_updateDatasets(e) {
		if (this.notifyPlugins("beforeDatasetsUpdate", {
			...
			for (let t = 0, n = this.data.datasets.length; t < n; ++t) this._updateDataset(t, Ne(e) ? e({ datasetIndex: t }) : e);
	...
	render() {
		this.notifyPlugins("beforeRender", { cancelable: !0 }) !== !1 && (kr.has(this) ? this.attached && !kr.running(this) && kr.start(this) : (this.draw(), Co({ chart: this })));
	}
	draw() {
		let e;
	...
	_drawDataset(e) {
		...
		this.notifyPlugins("beforeDatasetDraw", n) !== !1 && (r && Jt(t, r), e.controller.draw(), r && Yt(t), n.cancelable = !1, this.notifyPlugins("afterDatasetDraw", n));
	}
	isPointInArea(e) {
	...
	_updateVisibility(e, t, n) {
		...
		Me(t) ? (i.data[t].hidden = !n, this.update()) : (this.setDatasetVisibility(e, n), a.update(i, { visible: n }), this.update((t) => t.datasetIndex === e ? r : void 0));
	}
	hide(e, t) {
	...
	_stop() {
		let e, t;
		for (this.stop(), kr.remove(this), e = 0, t = this.data.datasets.length; e < t; ++e) this._destroyDatasetMeta(e);
	}
	destroy() {
		this.notifyPlugins("beforeDestroy");
		let { canvas: e, ctx: t } = this;
		this._stop(), this.config.clearCache(), e && (this.unbindEvents(), Wt(e, t), this.platform.releaseContext(t), this.canvas = null, this.ctx = null), delete Eo[this.id], this.notifyPlugins("afterDestroy");
	}
	toBase64Image(...e) {
	...
	setActiveElements(e) {
		...
		be(n, t) || (this._active = n, this._lastEvent = null, this._updateHoverStyles(n, t));
	}
	notifyPlugins(e, t, n) {
	...
	_handleEvent(e, t, n) {
		let { _active: r = [], options: i } = this, a = t, o = this._getActiveElements(e, r, n, a), s = Fe(e), c = ko(e, this._lastEvent, n, s);
...
function jo() {
	return I(Ao.instances, (e) => e._plugins.invalidate());
}
function Mo(e, t, n) {
...
function Fo(e, t, n, r) {
	let i = Po(e.options.borderRadius), a = (n - t) / 2, o = Math.min(a, r * t / 2), s = (e) => {
...
function Lo(e, t, n, r, i, a) {
	...
	let h = (m - Math.max(.001, m * d - n / L) / d) / 2, g = c + h + p, _ = i - h - p, { outerStart: v, outerEnd: y, innerStart: b, innerEnd: x } = Fo(t, f, d, _ - g), S = d - v, C = d - y, w = g + v / S, T = _ - y / C, E = f + b, D = f + x, ee = g + b / E, O = _ - x / D;
	if (e.beginPath(), a) {
		let t = (w + T) / 2;
...
function Ro(e, t, n, r, i) {
	...
	return Lo(e, t, n, r, c, i), e.fill(), c;
}
function zo(e, t, n, r, i) {
	...
	m && No(e, t, h), c.selfJoin && h - o >= L && p === 0 && u !== "miter" && Mo(e, t, h), a || (Lo(e, t, n, r, h, i), e.stroke());
}
var Bo = class extends Sa {
	static id = "arc";
	static defaults = {
		borderAlign: "center",
		borderColor: "#fff",
	...
	inRange(e, t, n) {
		let { angle: r, distance: i } = Ze(this.getProps(["x", "y"], n), {
			x: e,
			y: t
			...
			"outerRadius",
			"circumference"
		], n), u = (this.options.spacing + this.options.borderWidth) / 2, d = P(l, o - a), f = et(r, a, o) && a !== o, p = d >= R || f, m = nt(i, s + u, c + u);
		return p && m;
	}
	getCenterPoint(e) {
	...
	draw(e) {
		...
		e.fillStyle = t.backgroundColor, e.strokeStyle = t.borderColor, Ro(e, this, s, i, a), zo(e, this, s, i, a), e.restore();
	}
};
function Vo(e, t, n = t) {
...
function Uo(e) {
	return e.stepped ? Xt : e.tension || e.cubicInterpolationMode === "monotone" ? Zt : Ho;
}
function Wo(e, t, n = {}) {
...
function Go(e, t, n, r) {
	let { points: i, options: a } = t, { count: o, start: s, loop: c, ilen: l } = Wo(i, n, r), u = Uo(a), { move: d = !0, reverse: f } = r || {}, p, m, h;
...
function Ko(e, t, n, r) {
	let i = t.points, { count: a, start: o, ilen: s } = Wo(i, n, r), { move: c = !0, reverse: l } = r || {}, u = 0, d = 0, f, p, m, h, g, _, v = (e) => (o + (l ? s - e : e)) % a, y = () => {
...
function qo(e) {
	...
	return !e._decimated && !e._loop && !t.tension && t.cubicInterpolationMode !== "monotone" && !t.stepped && !n ? Ko : Go;
}
function Jo(e) {
	return e.stepped ? sr : e.tension || e.cubicInterpolationMode === "monotone" ? cr : or;
}
function Yo(e, t, n, r) {
	let i = t._path;
	i || (i = t._path = new Path2D(), t.path(i, n, r) && i.closePath()), Vo(e, t.options), e.stroke(i);
}
function Xo(e, t, n, r) {
	let { segments: i, options: a } = t, o = qo(t);
	for (let s of i) Vo(e, a, s.style), e.beginPath(), o(e, t, s, {
		start: n,
		end: n + r - 1
	}) && e.closePath(), e.stroke();
}
var Zo = typeof Path2D == "function";
function Qo(e, t, n, r) {
	Zo && !t.options.segment ? Yo(e, t, n, r) : Xo(e, t, n, r);
}
var $o = class extends Sa {
	static id = "line";
	static defaults = {
		borderCapStyle: "butt",
		borderDash: [],
	...
	updateControlPoints(e, t) {
		...
		if ((n.tension || n.cubicInterpolationMode === "monotone") && !n.stepped && !this._pointsUpdated) {
			...
			Un(this._points, n, e, r, t), this._pointsUpdated = !0;
		}
	}
	set points(e) {
	...
	get segments() {
		return this._segments ||= xr(this, this.options.segment);
	}
	first() {
	...
	interpolate(e, t) {
		let n = this.options, r = e[t], i = this.points, a = vr(this, {
			property: t,
			start: r,
			end: r
		});
	...
	pathSegment(e, t, n) {
		return qo(this)(e, this, t, n);
	}
	path(e, t, n) {
		let r = this.segments, i = qo(this), a = this._loop;
	...
	draw(e, t, n, r) {
		let i = this.options || {};
		(this.points || []).length && i.borderWidth && (e.save(), Qo(e, this, n, r), e.restore()), this.animated && (this._pointsUpdated = !1, this._path = void 0);
	}
};
function es(e, t, n, r) {
...
var ts = class extends Sa {
	...
	inXRange(e, t) {
		return es(this, e, "x", t);
	}
	inYRange(e, t) {
		return es(this, e, "y", t);
	}
	getCenterPoint(e) {
		let { x: t, y: n } = this.getProps(["x", "y"], e);
		return {
	...
	draw(e, t) {
		let n = this.options;
		this.skip || n.radius < .1 || !qt(this, t, this.size(n) / 2) || (e.strokeStyle = n.borderColor, e.lineWidth = n.borderWidth, e.fillStyle = n.backgroundColor, Gt(e, n, this.x, this.y));
	}
	getRange() {
		let e = this.options || {};
...
function is(e, t, n) {
	let r = e.options.borderWidth, i = e.borderSkipped, a = ln(r);
	return {
		t: rs(i.top, a.top, 0, n),
		r: rs(i.right, a.right, 0, t),
		b: rs(i.bottom, a.bottom, 0, n),
		l: rs(i.left, a.left, 0, t)
	};
}
function as(e, t, n) {
	let { enableBorderRadius: r } = e.getProps(["enableBorderRadius"]), i = e.options.borderRadius, a = un(i), o = Math.min(t, n), s = e.borderSkipped, c = r || j(i);
	return {
		topLeft: rs(!c || s.top || s.left, a.topLeft, 0, o),
		topRight: rs(!c || s.top || s.right, a.topRight, 0, o),
		bottomLeft: rs(!c || s.bottom || s.left, a.bottomLeft, 0, o),
		bottomRight: rs(!c || s.bottom || s.right, a.bottomRight, 0, o)
	};
}
function os(e) {
	let t = ns(e), n = t.right - t.left, r = t.bottom - t.top, i = is(e, n / 2, r / 2), a = as(e, n / 2, r / 2);
	return {
		outer: {
			x: t.left,
			y: t.top,
...
function ss(e, t, n, r) {
	let i = t === null, a = n === null, o = e && !(i && a) && ns(e, r);
	return o && (i || nt(t, o.left, o.right)) && (a || nt(n, o.top, o.bottom));
}
function cs(e) {
...
var ds = /*#__PURE__*/ Object.freeze({
	...
	BarElement: class extends Sa {
		...
		draw(e) {
			let { inflateAmount: t, options: { borderColor: n, backgroundColor: r } } = this, { inner: i, outer: a } = os(this), o = cs(a.radius) ? nn : ls;
			e.save(), (a.w !== i.w || a.h !== i.h) && (e.beginPath(), o(e, us(a, t, i)), e.clip(), o(e, us(i, -t, a)), e.fillStyle = n, e.fill("evenodd")), e.beginPath(), o(e, us(i, t)), e.fillStyle = r, e.fill(), e.restore();
		}
		inRange(e, t, n) {
			return ss(this, e, t, n);
		}
		inXRange(e, t) {
			return ss(this, e, null, t);
		}
		inYRange(e, t) {
			return ss(this, null, e, t);
		}
		getCenterPoint(e) {
	...
	"rgb(153, 102, 255)",
	"rgb(201, 203, 207)"
], ps = /* #__PURE__ */ fs.map((e) => e.replace("rgb(", "rgba(").replace(")", ", 0.5)"));
function ms(e) {
	return fs[e % fs.length];
}
function hs(e) {
	return ps[e % ps.length];
}
function gs(e, t) {
	return e.borderColor = ms(t), e.backgroundColor = hs(t), ++t;
}
function _s(e, t) {
	return e.backgroundColor = e.data.map(() => ms(t++)), t;
}
function vs(e, t) {
	return e.backgroundColor = e.data.map(() => hs(t++)), t;
}
function ys(e) {
	let t = 0;
	return (n, r) => {
		let i = e.getDatasetMeta(r).controller;
		i instanceof bi ? t = _s(n, t) : i instanceof Si ? t = vs(n, t) : i && (t = gs(n, t));
	};
}
function bs(e) {
	let t;
...
var Cs = {
	...
	beforeLayout(e, t, n) {
		if (!n.enabled) return;
		let { data: { datasets: r }, options: i } = e.config, { elements: a } = i, o = bs(r) || xs(i) || a && bs(a) || Ss();
...
function Os(e, t) {
	...
	return c && (r = U(it(t, a.axis, o).lo, 0, n - 1)), i = l ? U(it(t, a.axis, s).hi + 1, r, n) - r : n - r, {
		start: r,
		count: i
	};
}
var ks = {
	...
	beforeElementsUpdate: (e, t, n) => {
		...
		e.data.datasets.forEach((t, i) => {
			...
			if (dn([o, e.options.indexAxis]) === "y" || !s.controller.supportsDecimation) return;
			let l = e.scales[s.xAxisID];
			if (l.type !== "linear" && l.type !== "time" || e.options.parsing) return;
			let { start: u, count: d } = Os(s, c);
...
function As(e, t, n) {
	...
	for (let e of r) {
		...
		let l = vr(t, c);
		for (let t of l) {
			let r = js(n, a[t.start], a[t.end], t.loop), s = _r(e, i, r);
			for (let e of s) o.push({
				source: e,
				target: t,
				start: { [n]: Ps(c, r, "start", Math.max) },
				end: { [n]: Ps(c, r, "end", Math.min) }
			});
		}
	}
	return o;
...
function Fs(e, t) {
	let n = [], r = !1;
	return A(e) ? (r = !0, n = e) : n = Ms(e, t), n.length ? new $o({
		points: n,
		options: { tension: 0 },
		_loop: r,
		_fullLoop: r
...
function Rs(e, t, n) {
	let r = Hs(e);
	if (j(r)) return !isNaN(r.value) && r;
	let i = parseFloat(r);
	return M(i) && Math.floor(i) === i ? zs(r[0], t, i, n) : [
		"origin",
		"start",
		"end",
		"stack",
...
function Us(e) {
	let { scale: t, index: n, line: r } = e, i = [], a = r.segments, o = r.points, s = Ws(t, n);
	s.push(Fs({
		x: null,
		y: t.bottom
	}, r));
	for (let e = 0; e < a.length; e++) {
		let t = a[e];
		for (let e = t.start; e <= t.end; e++) Gs(i, o[e], s);
	}
	return new $o({
		points: i,
		options: {}
...
function Gs(e, t, n) {
	...
	for (let i = 0; i < n.length; i++) {
		let a = n[i], { first: o, last: s, point: c } = Ks(a, t, "x");
		if (!(!c || o && s)) {
			if (o) r.unshift(c);
...
function Js(e) {
	...
	if (M(n)) return Ys(t, n);
	if (n === "stack") return Us(e);
	if (n === "shape") return !0;
	let i = Xs(e);
	return i instanceof qs ? i : Fs(i, r);
}
function Ys(e, t) {
...
function Xs(e) {
	return (e.scale || {}).getPointPositionForValue ? Qs(e) : Zs(e);
}
function Zs(e) {
	let { scale: t = {}, fill: n } = e, r = Bs(n, t);
	if (M(r)) {
...
function Qs(e) {
	let { scale: t, fill: n } = e, r = t.options, i = t.getLabels().length, a = r.reverse ? t.max : t.min, o = Vs(n, t, a), s = [];
	if (r.grid.circular) {
...
function $s(e, t, n) {
	let r = Js(t), { chart: i, index: a, line: o, scale: s, axis: c } = t, l = o.options, u = l.fill, d = l.backgroundColor, { above: f = d, below: p = d } = u || {}, m = Or(i, i.getDatasetMeta(a));
	r && o.points.length && (Jt(e, n), ec(e, {
		line: o,
		target: r,
		above: f,
		below: p,
...
function ec(e, t) {
	...
	a !== i && (l === "x" ? (tc(e, r, o.top), rc(e, {
		...
		property: l,
		clip: c
	}), e.restore(), e.save(), tc(e, r, o.bottom)) : l === "y" && (nc(e, r, o.left), rc(e, {
		line: n,
		target: r,
		color: a,
		scale: s,
		property: l,
		clip: c
	}), e.restore(), e.save(), nc(e, r, o.right), u = i)), rc(e, {
		line: n,
		target: r,
		color: u,
		scale: s,
...
function tc(e, t, n) {
	...
	e.beginPath();
	for (let s of r) {
		let { start: r, end: c } = s, l = i[r], u = i[Ns(r, c, i)];
...
function rc(e, t) {
	let { line: n, target: r, property: i, color: a, scale: o, clip: s } = t, c = As(n, r, i);
	for (let { source: t, target: l, start: u, end: d } of c) {
		let { style: { backgroundColor: c = a } = {} } = t, f = r !== !0;
		e.save(), e.fillStyle = c, ic(e, o, s, f && js(i, u, d)), e.beginPath();
		let p = !!n.pathSegment(e, t), m;
		if (f) {
			p ? e.closePath() : ac(e, r, d, i);
...
var oc = {
	...
	afterDatasetsUpdate(e, t, n) {
		...
		for (o = 0; o < r; ++o) a = e.getDatasetMeta(o), s = a.dataset, c = null, s && s.options && s instanceof $o && (c = {
		...
		for (o = 0; o < r; ++o) c = i[o], !(!c || c.fill === !1) && (c.fill = Ls(i, o, n.propagate));
	},
	beforeDraw(e, t, n) {
		let r = n.drawTime === "beforeDraw", i = e.getSortedVisibleDatasetMetas(), a = e.chartArea;
		for (let t = i.length - 1; t >= 0; --t) {
			let n = i[t].$filler;
			n && (n.line.updateControlPoints(a, n.axis), r && n.fill && $s(e.ctx, n, a));
		}
	},
	beforeDatasetsDraw(e, t, n) {
		...
		for (let t = r.length - 1; t >= 0; --t) {
			let n = r[t].$filler;
			Is(n) && $s(e.ctx, n, e.chartArea);
		}
	},
	beforeDatasetDraw(e, t, n) {
		let r = t.meta.$filler;
		!Is(r) || n.drawTime !== "beforeDatasetDraw" || $s(e.ctx, r, e.chartArea);
	},
	defaults: {
		propagate: !0,
...
}, cc = (e, t) => e !== null && t !== null && e.datasetIndex === t.datasetIndex && e.index === t.index, lc = class extends Sa {
	constructor(e) {
	...
	fit() {
		...
		let n = e.labels, r = q(n.font), i = r.size, a = this._computeTitleHeight(), { boxWidth: o, itemHeight: s } = sc(n, i), c, l;
	...
	_fitCols(e, t, n, r) {
		...
		return this.legendItems.forEach((e, a) => {
			let { itemWidth: h, itemHeight: g } = uc(n, t, i, e, r);
	...
	adjustHitBoxes() {
		...
		let e = this._computeTitleHeight(), { legendHitBoxes: t, options: { align: n, labels: { padding: r }, rtl: i } } = this, a = dr(i, this.left, this.width);
		if (this.isHorizontal()) {
	...
	draw() {
		if (this.options.display) {
			let e = this.ctx;
			Jt(e, this), this._draw(), Yt(e);
		}
	}
	_draw() {
		let { options: e, columnSizes: t, lineWidths: n, ctx: r } = this, { align: i, labels: a } = e, o = G.color, s = dr(e.rtl, this.left, this.width), c = q(a.font), { padding: l } = a, u = c.size, d = u / 2, f;
		this.drawTitle(), r.textAlign = s.textAlign("left"), r.textBaseline = "middle", r.lineWidth = .5, r.font = c.string;
		let { boxWidth: p, boxHeight: m, itemHeight: h } = sc(a, u), g = function(e, t, n) {
			...
			if (r.fillStyle = P(n.fillStyle, o), r.lineCap = P(n.lineCap, "butt"), r.lineDashOffset = P(n.lineDashOffset, 0), r.lineJoin = P(n.lineJoin, "miter"), r.lineWidth = i, r.strokeStyle = P(n.strokeStyle, o), r.setLineDash(P(n.lineDash, [])), a.usePointStyle) {
				...
				Kt(r, o, c, l, a.pointStyleWidth && p);
			} else {
				let a = t + Math.max((u - m) / 2, 0), o = s.leftForLtr(e, p), c = un(n.borderRadius);
				r.beginPath(), Object.values(c).some((e) => e !== 0) ? nn(r, {
					x: o,
					y: a,
					w: p,
					h: m,
		...
		this.legendItems.forEach((o, u) => {
			...
			let w = s.x(S);
			if (g(w, C, o), S = ht(h, S + p + d, v ? S + x : this.right, e.rtl), _(s.x(S), C, o), v) f.x += x + l;
			else if (typeof o.text != "string") {
				let e = c.lineHeight;
				f.y += pc(o, e) + l;
			} else f.y += b;
		}), pr(this.ctx, e.textDirection);
	}
	drawTitle() {
		let e = this.options, t = e.title, n = q(t.font), r = K(t.padding);
		if (!t.display) return;
		let i = dr(e.rtl, this.left, this.width), a = this.ctx, o = t.position, s = n.size / 2, c = r.top + s, l, u = this.left, d = this.width;
		...
		let f = W(o, u, u + d);
		a.textAlign = i.textAlign(mt(o)), a.textBaseline = "middle", a.strokeStyle = t.color, a.fillStyle = t.color, a.font = n.string, tn(a, t.text, f, l, n);
	}
	_computeTitleHeight() {
	...
	_getLegendItemAt(e, t) {
		let n, r, i;
		if (nt(e, this.left, this.right) && nt(t, this.top, this.bottom)) {
			for (i = this.legendHitBoxes, n = 0; n < i.length; ++n) if (r = i[n], nt(e, r.left, r.left + r.width) && nt(t, r.top, r.top + r.height)) return this.legendItems[n];
		}
		return null;
	}
	handleEvent(e) {
		let t = this.options;
		if (!mc(e.type, t)) return;
		let n = this._getLegendItemAt(e.x, e.y);
		if (e.type === "mousemove" || e.type === "mouseout") {
			let r = this._hoveredItem, i = cc(r, n);
			r && !i && F(t.onLeave, [
				e,
				r,
				this
...
function uc(e, t, n, r, i) {
	return {
		itemWidth: dc(r, e, t, n),
		itemHeight: fc(i, r, t.lineHeight)
	};
}
function dc(e, t, n, r) {
	let i = e.text;
...
function fc(e, t, n) {
	let r = e;
	return typeof t.text != "string" && (r = pc(t, n)), r;
}
function pc(e, t) {
...
var vc = {
	...
	start(e, t, n) {
		...
		J.configure(e, r, n), J.addBox(e, r), yc.set(e, r);
	},
	stop(e) {
		J.removeBox(e, yc.get(e)), yc.delete(e);
	},
	beforeUpdate(e, t, n) {
		let r = yc.get(e);
		J.configure(e, r, n), r.options = n;
...
function Oc(e, t, n, r) {
	...
	return r === "center" ? l = i <= (s + c) / 2 ? "left" : "right" : i <= a / 2 ? l = "left" : i >= o - a / 2 && (l = "right"), Dc(l, e, t, n) && (l = "center"), l;
}
function kc(e, t, n) {
	let r = n.yAlign || t.yAlign || Ec(e, n);
	return {
		xAlign: n.xAlign || t.xAlign || Oc(e, t, n, r),
		yAlign: r
	};
}
function Ac(e, t) {
...
function jc(e, t, n) {
	let { y: r, height: i } = e;
	return t === "top" ? r += n : r -= t === "bottom" ? i + n : i / 2, r;
}
function Mc(e, t, n, r) {
	let { caretSize: i, caretPadding: a, cornerRadius: o } = e, { xAlign: s, yAlign: c } = n, l = i + a, { topLeft: u, topRight: d, bottomLeft: f, bottomRight: p } = un(o), m = Ac(t, s), h = jc(t, c, l);
...
function X(e, t, n, r) {
	let i = e[t].call(n, r);
	return i === void 0 ? Lc[t].call(n, r) : i;
}
var Rc = class extends Sa {
	static positioners = xc;
	constructor(e) {
	...
	_resolveAnimations() {
		...
		if (e) return e;
		let t = this.chart, n = this.options.setContext(this.getContext()), r = n.enabled && t.options.animation && n.animations, i = new Nr(this.chart, r);
		return r._cacheable && (this._cachedAnimations = Object.freeze(i)), i;
	}
	getContext() {
		return this.$context ||= Fc(this.chart.getContext(), this, this._tooltipItems);
	}
	getTitle(e, t) {
		let { callbacks: n } = t, r = X(n, "beforeTitle", this, e), i = X(n, "title", this, e), a = X(n, "afterTitle", this, e), o = [];
		return o = Sc(o, Cc(r)), o = Sc(o, Cc(i)), o = Sc(o, Cc(a)), o;
	}
	getBeforeBody(e, t) {
		return Pc(X(t.callbacks, "beforeBody", this, e));
	}
	getBody(e, t) {
		let { callbacks: n } = t, r = [];
		return I(e, (e) => {
			...
			Sc(t.before, Cc(X(i, "beforeLabel", this, e))), Sc(t.lines, X(i, "label", this, e)), Sc(t.after, Cc(X(i, "afterLabel", this, e))), r.push(t);
		}), r;
	}
	getAfterBody(e, t) {
		return Pc(X(t.callbacks, "afterBody", this, e));
	}
	getFooter(e, t) {
		let { callbacks: n } = t, r = X(n, "beforeFooter", this, e), i = X(n, "footer", this, e), a = X(n, "afterFooter", this, e), o = [];
		return o = Sc(o, Cc(r)), o = Sc(o, Cc(i)), o = Sc(o, Cc(a)), o;
	}
	_createItems(e) {
		let t = this._active, n = this.chart.data, r = [], i = [], a = [], o = [], s, c;
		for (s = 0, c = t.length; s < c; ++s) o.push(wc(this.chart, t[s]));
		return e.filter && (o = o.filter((t, r, i) => e.filter(t, r, i, n))), e.itemSort && (o = o.sort((t, r) => e.itemSort(t, r, n))), I(o, (t) => {
			let n = Ic(e.callbacks, t);
			r.push(X(n, "labelColor", this, t)), i.push(X(n, "labelPointStyle", this, t)), a.push(X(n, "labelTextColor", this, t));
	...
	update(e, t) {
		...
		if (!r.length) this.opacity !== 0 && (i = { opacity: 0 });
			...
			let e = xc[n.position].call(this, r, this._eventPosition);
			...
			let t = this._size = Tc(this, n), o = Object.assign({}, e, t), s = kc(this.chart, n, o), c = Mc(n, o, s, this.chart);
	...
	getCaretPosition(e, t, n) {
		let { xAlign: r, yAlign: i } = this, { caretSize: a, cornerRadius: o } = n, { topLeft: s, topRight: c, bottomLeft: l, bottomRight: u } = un(o), { x: d, y: f } = e, { width: p, height: m } = t, h, g, _, v, y, b;
	...
	drawTitle(e, t, n) {
		...
		if (i) {
			let c = dr(n.rtl, this.x, this.width);
			for (e.x = Nc(this, n.titleAlign, n), t.textAlign = c.textAlign(n.titleAlign), t.textBaseline = "middle", a = q(n.titleFont), o = n.titleSpacing, t.fillStyle = n.titleColor, t.font = a.string, s = 0; s < i; ++s) t.fillText(r[s], c.x(e.x), e.y + a.lineHeight / 2), e.y += a.lineHeight + o, s + 1 === i && (e.y += n.titleMarginBottom - o);
		}
	}
	_drawColorBox(e, t, n, r, i) {
		let a = this.labelColors[n], o = this.labelPointStyles[n], { boxHeight: s, boxWidth: c } = i, l = q(i.bodyFont), u = Nc(this, "left", i), d = r.x(u), f = s < l.lineHeight ? (l.lineHeight - s) / 2 : 0, p = t.y + f;
		if (i.usePointStyle) {
			let t = {
			...
			e.strokeStyle = i.multiKeyBackground, e.fillStyle = i.multiKeyBackground, Gt(e, t, n, l), e.strokeStyle = a.borderColor, e.fillStyle = a.backgroundColor, Gt(e, t, n, l);
		} else {
			...
			let t = r.leftForLtr(d, c), n = r.leftForLtr(r.xPlus(d, 1), c - 2), o = un(a.borderRadius);
			Object.values(o).some((e) => e !== 0) ? (e.beginPath(), e.fillStyle = i.multiKeyBackground, nn(e, {
				x: t,
				y: p,
				w: c,
				h: s,
				radius: o
			}), e.fill(), e.stroke(), e.fillStyle = a.backgroundColor, e.beginPath(), nn(e, {
				x: n,
				y: p + 1,
				w: c - 2,
				h: s - 2,
	...
	drawBody(e, t, n) {
		let { body: r } = this, { bodySpacing: i, bodyAlign: a, displayColors: o, boxHeight: s, boxWidth: c, boxPadding: l } = n, u = q(n.bodyFont), d = u.lineHeight, f = 0, p = dr(n.rtl, this.x, this.width), m = function(n) {
			t.fillText(n, p.x(e.x + f), e.y + d / 2), e.y += d + i;
		}, h = p.textAlign(a), g, _, v, y, b, x, S;
		for (t.textAlign = a, t.textBaseline = "middle", t.font = u.string, e.x = Nc(this, h, n), t.fillStyle = n.bodyColor, I(this.beforeBody, m), f = o && h !== "right" ? a === "center" ? c / 2 + l : c + 2 + l : 0, y = 0, x = r.length; y < x; ++y) {
	...
	drawFooter(e, t, n) {
		...
		if (i) {
			let s = dr(n.rtl, this.x, this.width);
			for (e.x = Nc(this, n.footerAlign, n), e.y += n.footerMarginTop, t.textAlign = s.textAlign(n.footerAlign), t.textBaseline = "middle", a = q(n.footerFont), t.fillStyle = n.footerColor, t.font = a.string, o = 0; o < i; ++o) t.fillText(r[o], s.x(e.x), e.y + a.lineHeight / 2), e.y += a.lineHeight + n.footerSpacing;
		}
	}
	drawBackground(e, t, n, r) {
		let { xAlign: i, yAlign: a } = this, { x: o, y: s } = e, { width: c, height: l } = n, { topLeft: u, topRight: d, bottomLeft: f, bottomRight: p } = un(r.cornerRadius);
	...
	_updateAnimationTarget(e) {
		...
		if (r || i) {
			let n = xc[e.position].call(this, this._active, this._eventPosition);
			if (!n) return;
			let a = this._size = Tc(this, e), o = Object.assign({}, n, this._size), s = kc(t, e, o), c = Mc(e, o, s, t);
	...
	draw(e) {
		...
		t.enabled && o && (e.save(), e.globalAlpha = n, this.drawBackground(i, e, r, t), fr(e, t.textDirection), i.y += a.top, this.drawTitle(i, e, t), this.drawBody(i, e, t), this.drawFooter(i, e, t), pr(e, t.textDirection), e.restore());
	}
	getActiveElements() {
		return this._active || [];
	}
	setActiveElements(e, t) {
		...
		}), i = !be(n, r), a = this._positionChanged(r, t);
	...
	handleEvent(e, t, n = !0) {
		...
		let r = this.options, i = this._active || [], a = this._getActiveElements(e, i, t, n), o = this._positionChanged(a, e), s = t || !be(a, i) || o;
	...
	_positionChanged(e, t) {
		let { caretX: n, caretY: r, options: i } = this, a = xc[i.position].call(this, e, t);
...
}), Bc = (e, t, n, r) => (typeof t == "string" ? (n = e.push(t) - 1, r.unshift({
	index: n,
	label: t
})) : isNaN(t) && (n = null), n);
function Vc(e, t, n, r) {
	let i = e.indexOf(t);
	return i === -1 ? Bc(e, t, n, r) : i === e.lastIndexOf(t) ? i : n;
}
var Hc = (e, t) => e === null ? null : U(Math.round(e), 0, t);
function Uc(e) {
	let t = this.getLabels();
	return e >= 0 && e < t.length ? t[e] : e;
}
var Wc = class extends Ha {
	static id = "category";
	static defaults = { ticks: { callback: Uc } };
	constructor(e) {
	...
	parse(e, t) {
		...
		return t = isFinite(t) && n[t] === e ? t : Vc(n, e, P(t, e), this._addedLabels), Hc(t, n.length - 1);
	}
	determineDataLimits() {
...
function Gc(e, t) {
	let n = [], { bounds: r, step: i, min: a, max: o, precision: s, count: c, maxTicks: l, maxDigits: u, includeBounds: d } = e, f = i || 1, p = l - 1, { min: m, max: h } = t, g = !k(a), _ = !k(o), v = !k(c), y = (h - m) / (u + 1), b = Ue((h - m) / p / f) * f, x, S, C, w;
	if (b < 1e-14 && !g && !_) return [{ value: m }, { value: h }];
	w = Math.ceil(h / b) - Math.floor(m / b), w > p && (b = Ue(w * b / p / f) * f), k(s) || (x = 10 ** s, b = Math.ceil(b * x) / x), r === "ticks" ? (S = Math.floor(m / b) * b, C = Math.ceil(h / b) * b) : (S = m, C = h), g && _ && i && qe((o - a) / i, b / 1e3) ? (w = Math.round(Math.min((o - a) / b, l)), b = (o - a) / w, S = a, C = o) : v ? (S = g ? a : S, C = _ ? o : C, w = c - 1, b = (C - S) / w) : (w = (C - S) / b, w = He(w, Math.round(w), b / 1e3) ? Math.round(w) : Math.ceil(w));
	let T = Math.max(Xe(b), Xe(S));
	x = 10 ** (k(s) ? T : s), S = Math.round(S * x) / x, C = Math.round(C * x) / x;
	let E = 0;
	for (g && (d && S !== a ? (n.push({ value: a }), S < a && E++, He(Math.round((S + E * b) * x) / x, a, Kc(a, y, e)) && E++) : S < a && E++); E < w; ++E) {
		let e = Math.round((S + E * b) * x) / x;
		if (_ && e > o) break;
		n.push({ value: e });
	}
	return _ && d && C !== o ? n.length && He(n[n.length - 1].value, o, Kc(o, y, e)) ? n[n.length - 1].value = o : n.push({ value: o }) : (!_ || C === o) && n.push({ value: C }), n;
}
function Kc(e, t, { horizontal: n, minRotation: r }) {
	let i = V(r), a = (n ? Math.sin(i) : Math.cos(i)) || .001, o = .75 * t * ("" + e).length;
	return Math.min(t / a, o);
}
var qc = class extends Ha {
	constructor(e) {
	...
	buildTicks() {
		...
		return e.bounds === "ticks" && Je(r, this, "value"), e.reverse ? (r.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), r;
	}
	configure() {
	...
	getLabelForValue(e) {
		return jt(e, this.chart.options.locale, this.options.ticks.format);
	}
}, Jc = class extends qc {
	static id = "linear";
	static defaults = { ticks: { callback: Pt.formatters.numeric } };
	determineDataLimits() {
...
}, Yc = (e) => Math.floor(Ve(e)), Xc = (e, t) => 10 ** (Yc(e) + t);
function Zc(e) {
	return e / 10 ** Yc(e) == 1;
}
function Qc(e, t, n) {
...
function $c(e, t) {
	...
	for (; Qc(e, t, n) > 10;) n++;
	for (; Qc(e, t, n) < 10;) n--;
	return Math.min(n, Yc(e));
}
function el(e, { min: t, max: n }) {
	t = N(e.min, t);
	let r = [], i = Yc(t), a = $c(t, n), o = a < 0 ? 10 ** Math.abs(a) : 1, s = 10 ** a, c = i > a ? 10 ** i : 0, l = Math.round((t - c) * o) / o, u = Math.floor((t - c) / s / 10) * s * 10, d = Math.floor((l - u) / 10 ** a), f = N(e.min, Math.round((c + u + d * 10 ** a) * o) / o);
	for (; f < n;) r.push({
		value: f,
		major: Zc(f),
		significand: d
...
var tl = class extends Ha {
	...
	static defaults = { ticks: {
		callback: Pt.formatters.logarithmic,
		major: { enabled: !0 }
	} };
	constructor(e) {
	...
	parse(e, t) {
		let n = qc.prototype.parse.apply(this, [e, t]);
		if (n === 0) {
			this._zero = !0;
			return;
		}
	...
	determineDataLimits() {
		let { min: e, max: t } = this.getMinMax(!0);
		this.min = M(e) ? Math.max(0, e) : null, this.max = M(t) ? Math.max(0, t) : null, this.options.beginAtZero && (this._zero = !0), this._zero && this.min !== this._suggestedMin && !M(this._userMin) && (this.min = e === Xc(this.min, 0) ? Xc(this.min, -1) : Xc(this.min, 0)), this.handleTickRangeOptions();
	}
	handleTickRangeOptions() {
		let { minDefined: e, maxDefined: t } = this.getUserBounds(), n = this.min, r = this.max, i = (t) => n = e ? n : t, a = (e) => r = t ? r : e;
		n === r && (n <= 0 ? (i(1), a(10)) : (i(Xc(n, -1)), a(Xc(r, 1)))), n <= 0 && i(Xc(r, -1)), r <= 0 && a(Xc(n, 1)), this.min = n, this.max = r;
	}
	buildTicks() {
		let e = this.options, t = el({
			min: this._userMin,
			max: this._userMax
		}, this);
		return e.bounds === "ticks" && Je(t, this, "value"), e.reverse ? (t.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), t;
	}
	getLabelForValue(e) {
		return e === void 0 ? "0" : jt(e, this.chart.options.locale, this.options.ticks.format);
	}
	configure() {
		let e = this.min;
		super.configure(), this._startValue = Ve(e), this._valueRange = Ve(this.max) - Ve(e);
	}
	getPixelForValue(e) {
		return (e === void 0 || e === 0) && (e = this.min), e === null || isNaN(e) ? NaN : this.getPixelForDecimal(e === this.min ? 0 : (Ve(e) - this._startValue) / this._valueRange);
	}
	getValueForPixel(e) {
...
function al(e) {
	...
	for (let c = 0; c < a; c++) {
		...
		i[c] = a.padding;
		let l = e.getPointPosition(c, e.drawingArea + i[c], s), u = q(a.font), d = rl(e.ctx, u, e._pointLabels[c]);
		r[c] = d;
		let f = H(e.getIndexAngle(c) + s), p = Math.round(Ye(f));
		ol(n, t, f, il(p, l.x, d.w, 0, 180), il(p, l.y, d.h, 90, 270));
	}
	e.setCenterPoint(t.l - n.l, n.r - t.r, t.t - n.t, n.b - t.b), e._pointLabelItems = ll(e, r, i);
}
...
function sl(e, t, n) {
	let r = e.drawingArea, { extra: i, additionalAngle: a, padding: o, size: s } = n, c = e.getPointPosition(t, r + i + o, a), l = Math.round(Ye(H(c.angle + z))), u = fl(c.y, s.h, l), d = ul(l), f = dl(c.x, s.w, d);
	return {
		visible: !0,
		x: c.x,
		y: u,
...
function ll(e, t, n) {
	...
	for (let a = 0; a < i; a++) {
		...
		let i = sl(e, a, c);
		r.push(i), s === "auto" && (i.visible = cl(i, l), i.visible && (l = i));
	}
	return r;
}
function ul(e) {
...
function pl(e, t, n) {
	...
	if (!k(s)) {
		let n = un(t.borderRadius), c = K(t.backdropPadding);
		e.fillStyle = s;
		let l = r - c.left, u = i - c.top, d = a - r + c.width, f = o - i + c.height;
		Object.values(n).some((e) => e !== 0) ? (e.beginPath(), nn(e, {
			x: l,
			y: u,
			w: d,
			h: f,
...
function ml(e, t) {
	...
	for (let i = t - 1; i >= 0; i--) {
		...
		tn(n, e._pointLabels[i], s, c + o.lineHeight / 2, o, {
			color: a.color,
			textAlign: l,
			textBaseline: "middle"
		});
...
function gl(e, t, n, r, i) {
	...
	!o && !r || !s || !c || n < 0 || (a.save(), a.strokeStyle = s, a.lineWidth = c, a.setLineDash(i.dash || []), a.lineDashOffset = i.dashOffset, a.beginPath(), hl(e, n, o, r), a.closePath(), a.stroke(), a.restore());
}
function _l(e, t, n) {
	return pn(e, {
		label: n,
...
var vl = class extends qc {
	...
	setDimensions() {
		let e = this._padding = K(nl(this.options) / 2), t = this.width = this.maxWidth - e.width, n = this.height = this.maxHeight - e.height;
	...
	computeTickLimit() {
		return Math.ceil(this.drawingArea / nl(this.options));
	}
	generateTickLabels(e) {
		qc.prototype.generateTickLabels.call(this, e), this._pointLabels = this.getLabels().map((e, t) => {
	...
	fit() {
		let e = this.options;
		e.display && e.pointLabels.display ? al(this) : this.setCenterPoint(0, 0, 0, 0);
	}
	...
	drawBackground() {
		...
		if (e) {
			let n = this.ctx;
			n.save(), n.beginPath(), hl(this, this.getDistanceFromCenterForValue(this._endValue), t, this._pointLabels.length), n.closePath(), n.fillStyle = e, n.fill(), n.restore();
		}
	}
	drawGrid() {
		let e = this.ctx, t = this.options, { angleLines: n, grid: r, border: i } = t, a = this._pointLabels.length, o, s, c;
		if (t.pointLabels.display && ml(this, a), r.display && this.ticks.forEach((e, t) => {
...
function xl(e, t) {
	...
	return typeof r == "function" && (o = r(o)), M(o) || (o = typeof r == "string" ? n.parse(o, r) : n.parse(o)), o === null ? null : (i && (o = i === "week" && (Ke(a) || a === !0) ? n.startOf(o, "isoWeek", a) : n.startOf(o, i)), +o);
}
function Sl(e, t, n, r) {
	let i = Z.length;
	for (let a = Z.indexOf(e); a < i - 1; ++a) {
		let e = yl[Z[a]], i = e.steps ? e.steps : 2 ** 53 - 1;
		if (e.common && Math.ceil((n - t) / (i * e.size)) <= r) return Z[a];
	}
	return Z[i - 1];
}
function Cl(e, t, n, r, i) {
	for (let a = Z.length - 1; a >= Z.indexOf(n); a--) {
		let n = Z[a];
		if (yl[n].common && e._adapter.diff(i, r, n) >= t - 1) return n;
	}
	return Z[n ? Z.indexOf(n) : 0];
}
function wl(e) {
	for (let t = Z.indexOf(e) + 1, n = Z.length; t < n; ++t) if (yl[Z[t]].common) return Z[t];
}
function Tl(e, t, n) {
	if (!n) e[t] = !0;
	else if (n.length) {
		let { lo: r, hi: i } = rt(n, t), a = n[r] >= t ? n[r] : n[i];
		e[a] = !0;
	}
}
function El(e, t, n, r) {
...
function Dl(e, t, n) {
	...
	return a === 0 || !n ? r : El(e, r, i, n);
}
var Ol = class extends Ha {
	static id = "time";
	static defaults = {
		bounds: "data",
		adapters: {},
	...
	init(e, t = {}) {
		let n = e.time ||= {}, r = this._adapter = new Di._date(e.adapters.date);
		r.init(t), Te(n.displayFormats, r.formats()), this._parseOpts = {
			parser: n.parser,
			round: n.round,
	...
	parse(e, t) {
		return e === void 0 ? null : xl(this, e);
	}
	beforeLayout() {
	...
	buildTicks() {
		...
		let i = this.min, a = this.max, o = ot(r, i, a);
		return this._unit = t.unit || (n.autoSkip ? Sl(t.minUnit, this.min, this.max, this._getLabelCapacity(i)) : Cl(this, o.length, t.minUnit, this.min, this.max)), this._majorUnit = !n.major.enabled || this._unit === "year" ? void 0 : wl(this._unit), this.initOffsets(r), e.reverse && o.reverse(), Dl(this, o, this._majorUnit);
	}
	afterAutoSkip() {
	...
	_generate() {
		let e = this._adapter, t = this.min, n = this.max, r = this.options, i = r.time, a = i.unit || Sl(i.minUnit, t, n, this._getLabelCapacity(t)), o = P(r.ticks.stepSize, 1), s = a === "week" && i.isoWeekday, c = Ke(s) || s === !0, l = {}, u = t, d, f;
		...
		for (d = u, f = 0; d < n; d = +e.add(d, o, a), f++) Tl(l, d, p);
		return (d === n || r.bounds === "ticks" || f === 1) && Tl(l, d, p), Object.keys(l).sort(bl).map((e) => +e);
	}
	getLabelForValue(e) {
	...
	_getLabelCapacity(e) {
		let t = this.options.time, n = t.displayFormats, r = n[t.unit] || n.millisecond, i = this._tickFormatFunction(e, 0, Dl(this, [e], this._majorUnit), r), a = this._getLabelSize(i), o = Math.floor(this.isHorizontal() ? this.width / a.w : this.height / a.h) - 1;
		return o > 0 ? o : 1;
	}
	getDataTimestamps() {
	...
	getLabelTimestamps() {
		...
		for (t = 0, n = r.length; t < n; ++t) e.push(xl(this, r[t]));
...
function kl(e, t, n) {
	...
	n ? (t >= e[r].pos && t <= e[i].pos && ({lo: r, hi: i} = it(e, "pos", t)), {pos: a, time: s} = e[r], {pos: o, time: c} = e[i]) : (t >= e[r].time && t <= e[i].time && ({lo: r, hi: i} = it(e, "time", t)), {time: a, pos: s} = e[r], {time: o, pos: c} = e[i]);
	let l = o - a;
...
var Al = class extends Ol {
	...
	initOffsets() {
		...
		this._minPos = kl(t, this.min), this._tableRange = kl(t, this.max) - this._minPos, super.initOffsets(e);
	}
	buildLookupTable(e) {
	...
	getValueForPixel(e) {
		let t = this._offsets, n = this.getDecimalForPixel(e) / t.factor - t.end;
		return kl(this._table, n * this._tableRange + this._minPos, !0);
	}
}, jl = [
	Ti,
	ds,
...
var Ml = [
	...
	popover: "240 5% 7%"
}, Fl = /* @__PURE__ */ new WeakMap(), Il = (e) => {
	let t = Fl.get(e);
	if (t?.isConnected) return t;
	let n = e.parentElement, r = e.ownerDocument;
	if (!n || !r.defaultView) return;
	let i = r.createElement("span");
	return i.setAttribute("aria-hidden", "true"), i.style.position = "absolute", i.style.width = "0", i.style.height = "0", i.style.overflow = "hidden", i.style.pointerEvents = "none", i.style.visibility = "hidden", n.append(i), Fl.set(e, i), i;
}, Ll = (e, t) => {
	if (t >= 1) return e;
	let n = e.match(/[\d.]+/g)?.slice(0, 3);
	return !n || n.length < 3 ? e : `rgba(${n.join(", ")}, ${t})`;
}, Rl = (e, t, n = 1) => {
	let r = Nl[t] ?? Nl.foreground, i = Il(e);
	return i ? (i.style.color = Pl[t] ? `hsl(var(--${t}, ${Pl[t]}))` : `var(--${t}, ${r})`, Ll((e.ownerDocument.defaultView?.getComputedStyle(i).color ?? r) || r, n)) : Ll(r, n);
}, zl = (e) => {
	Fl.get(e)?.remove(), Fl.delete(e);
}, Bl = (e, t = 1, n = !1) => (r) => {
	let i = Ml[(n ? r.dataIndex : e) % Ml.length] ?? Ml[0];
	return Rl(r.chart.canvas, i, t);
}, Q = (e, t = 1) => (n) => Rl(n.chart.canvas, e, t), Vl = (e, t, n) => {
	e[t] === void 0 && (e[t] = n);
}, Hl = (e, t) => ({
	...t,
	datasets: t.datasets.map((t, n) => {
		let r = { ...t };
		return e === "pie" || e === "doughnut" || e === "polarArea" ? (Vl(r, "backgroundColor", Bl(n, .88, !0)), Vl(r, "hoverBackgroundColor", Bl(n, 1, !0)), Vl(r, "borderColor", Q("background")), Vl(r, "borderWidth", 2), r) : (Vl(r, "borderColor", Bl(n)), Vl(r, "backgroundColor", Bl(n, e === "bar" ? .82 : .18)), (e === "line" || e === "radar") && (Vl(r, "pointBackgroundColor", Bl(n)), Vl(r, "pointBorderColor", Q("background"))), r);
	})
}), $ = (e) => typeof e == "object" && e && !Array.isArray(e) ? e : {}, Ul = (e, t) => {
	let n = $(e), r = $(t);
	return {
		...n,
		...r,
	...
	return Object.fromEntries(Array.from(n, (n) => [n, Ul(e[n], t[n])]));
}, Gl = {
	x: {
		border: { display: !1 },
		grid: { display: !1 },
		ticks: {
			color: Q("muted-foreground"),
			maxRotation: 0,
			padding: 8
		}
	},
	...
	angleLines: { color: Q("border", .55) },
	beginAtZero: !0,
	grid: { color: Q("border", .55) },
	pointLabels: { color: Q("muted-foreground") },
	ticks: {
		backdropColor: "transparent",
		color: Q("muted-foreground")
	}
} }, ql = (e, t) => {
	let n = t ?? {}, r = $(n.plugins), i = $(r.legend), a = $(r.tooltip), o = $(n.elements), s = e === "pie" || e === "doughnut", c = e === "line" || e === "bar" ? Wl(Gl, $(n.scales)) : e === "radar" || e === "polarArea" ? Wl(Kl, $(n.scales)) : n.scales, l = {
		responsive: !0,
		maintainAspectRatio: !1,
		...n,
		animation: n.animation !== !1 && {
			duration: 220,
			easing: "easeOutQuart",
			...$(n.animation)
		},
		...
		plugins: {
			...
			tooltip: {
				backgroundColor: Q("popover"),
				bodyColor: Q("card-foreground"),
				borderColor: Q("border"),
				borderWidth: 1,
				boxPadding: 4,
				cornerRadius: 8,
				padding: 12,
				titleColor: Q("muted-foreground"),
				...a
			}
		},
		scales: c
	};
	return e === "line" && (l.elements = {
		...o,
		line: {
			borderWidth: 2,
			tension: .35,
	...
	}), e === "doughnut" && n.cutout === void 0 && (l.cutout = "64%"), l;
}, Jl = /* @__PURE__ */ new WeakMap(), Yl = (e) => $($($($(e).plugins).legend).labels), Xl = (e) => ({
	id: "gui-theme",
	beforeLayout: (t) => {
		let n = Yl(e()), r = Yl(t.options);
		if (n.color === void 0 && (r.color = Rl(t.canvas, "muted-foreground")), $($(e()).font).family === void 0) {
			let e = t.canvas.ownerDocument.defaultView?.getComputedStyle(t.canvas).getPropertyValue("--font-family").trim();
			e && t.options?.font && (t.options.font.family = e);
		}
	},
	afterInit: (e) => {
		let t = e.canvas.ownerDocument;
		if (!t.defaultView?.MutationObserver) return;
		let n = new t.defaultView.MutationObserver(() => {
			let n = Jl.get(e);
			!n || n.frame !== void 0 || (n.frame = t.defaultView?.requestAnimationFrame(() => {
				n.frame = void 0, e.update("none");
			}));
	...
	afterDestroy: (e) => {
		let t = Jl.get(e);
		t?.frame !== void 0 && e.canvas.ownerDocument.defaultView?.cancelAnimationFrame(t.frame), t?.observer.disconnect(), Jl.delete(e), zl(e.canvas);
	}
});
//#endregion
export { _i as a, xi as c, wi as d, Hl as i, Ci as l, ql as n, Ao as o, Xl as r, bi as s, Ml as t, Si as u };
