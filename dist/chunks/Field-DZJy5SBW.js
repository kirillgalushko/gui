...
import '../assets/Field-LQSlqewz.css';const v = ["data-invalid", "data-disabled"], f = /* @__PURE__ */ i({
  __name: "Field",
  props: {
  ...
  setup(d) {
    ...
    return l("field-state", a), (t, _) => (s(), n("div", {
      class: r(["field", e.orientation, { invalid: e.invalid, disabled: e.disabled, stretched: e.stretched }]),
...
}), b = /* @__PURE__ */ p(f, [["__scopeId", "data-v-274e40d2"]]);
export {
  b as default
};
