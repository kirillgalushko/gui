...
import '../assets/Tooltip-Cd6-9jdi.css';//#region src/components/Tooltip/Tooltip.vue?vue&type=script&setup=true&lang.ts
var u = /*@__PURE__*/ i({
	__name: "Tooltip",
	props: {
	...
	setup(e) {
		...
		return (e, i) => (o(), r(c(n), a(e.$attrs, {
			delay: t.delay,
			arrowOverflow: !1,
			popperClass: t.mode === "contrast" ? ["tooltip-contrast", "v-popper__popper--skip-transition"] : ["tooltip-default", "v-popper__popper--skip-transition"],
			class: [
				"tooltip",
				t.mode,
...
}), d = /* @__PURE__ */ e({ default: () => f }), f = /*#__PURE__*/ t(u, [["__scopeId", "data-v-799de72b"]]);
//#endregion
