...
import ce from "./FieldHelper-C_7J0GKU.js";
import { _ as ve } from "./_plugin-vue_export-helper-CHgC5LLL.js";
import '../assets/PincodeInput-BngTx8YX.css';const pe = ["value", "disabled", "readonly", "maxlength", "aria-invalid", "aria-describedby"], fe = {
  class: "pincode-grid",
  "aria-hidden": "true"
  ...
  setup(R, { emit: P }) {
    const n = R, D = P, I = te(), T = le(), i = $(null), l = $(0), r = o(
      () => Math.max(1, Math.floor(Number(n.length) || 1))
    ), v = (e) => String(e ?? "").replace(/\D/g, "").slice(0, r.value), N = (e, t) => t === null ? v(e).length : v(e.slice(0, t)).length, E = (e) => e === "" || e === !0 || e === "true", u = o(() => v(n.modelValue)), d = o(() => n.disabled || n.loading), c = o(
      () => n.succeed || E(I.readonly)
    ), L = o(
      () => Array.from(
        { length: r.value },
        (e, t) => u.value[t] ?? ""
      ...
      () => Math.min(l.value, r.value - 1)
    ), H = o(() => l.value < r.value), K = o(() => n.invalid ? !!n.errorMessage : !!n.description), b = o(() => {
      if (K.value)
      ...
      l.value = p(
        s,
        a
      ), D("update:modelValue", a), x(a, s);
    }, O = (e) => {
      const t = e.target;
      J(
        t.value,
        N(t.value, t.selectionStart)
      );
...
}), Ie = /* @__PURE__ */ ve(me, [["__scopeId", "data-v-e1936b73"]]);
export {
  Ie as default
};
