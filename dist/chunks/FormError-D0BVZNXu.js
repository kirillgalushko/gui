...
import '../assets/FormError-BK-yhB8I.css';const A = { class: "form-error-content" }, B = { class: "form-error-message-box" }, N = /* @__PURE__ */ i({
  __name: "FormError",
  props: {
    message: {},
  ...
  setup(m) {
    ...
    return (V, C) => (t(), a(s, { name: "form-error" }, {
      default: r(() => [
        e.message ? (t(), f("div", {
          key: 0,
          class: "form-error",
...
}), P = /* @__PURE__ */ k(N, [["__scopeId", "data-v-2eaf5829"]]);
export {
  P as default
};
