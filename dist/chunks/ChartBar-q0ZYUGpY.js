import { n as e, t } from "./useChart-BUu153me.js";
...
//#endregion
//#region src/components/Chart/ChartBar.vue
var c = /* @__PURE__ */ i({
	__name: "ChartBar",
	props: {
		data: {},
	...
	setup(i) {
		let c = i, { chartData: l, chartOptions: u, chartPlugins: d, containerStyle: f } = t("bar", c);
		return (t, i) => (o(), n("div", {
