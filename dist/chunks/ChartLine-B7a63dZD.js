import { i as e, t } from "./useChart-BUu153me.js";
...
//#endregion
//#region src/components/Chart/ChartLine.vue
var c = /* @__PURE__ */ i({
	__name: "ChartLine",
	props: {
		data: {},
	...
	setup(i) {
		let c = i, { chartData: l, chartOptions: u, chartPlugins: d, containerStyle: f } = t("line", c);
		return (t, i) => (o(), n("div", {
