import { defineComponent as y, computed as s, ref as f, watch as D, openBlock as i, createElementBlock as u, normalizeStyle as d, Fragment as $, renderList as C, createElementVNode as W } from "vue";
import { _ as w } from "./_plugin-vue_export-helper-CHgC5LLL.js";
import '../assets/ProgressBar-DCgHKRV9.css';const B = ["aria-valuenow", "aria-valuemax"], c = 450, k = /* @__PURE__ */ y({
  __name: "ProgressBar",
  props: {
    progress: { default: 0 },
    max: { default: 100 },
  ...
  setup(M) {
    const a = M, l = s(() => Math.max(1, a.max)), m = s(
      () => Math.min(l.value, Math.max(0, a.progress))
    ), o = s(() => Math.max(1, Math.floor(a.segments))), n = s(
      () => m.value / l.value * o.value
    ), g = f(!0), h = f(n.value);
    D(n, (e, r) => {
    ...
    }, b = s(() => Array.from({ length: o.value }, (e, r) => {
      const t = Math.min(
        100,
        Math.max(0, (n.value - r) * 100)
      );
      return {
        id: r,
        fill: t,
    ...
    return (e, r) => (i(), u("div", {
      ...
      (i(!0), u($, null, C(b.value, (t) => (i(), u("div", {
        key: t.id,
...
}), E = /* @__PURE__ */ w(k, [["__scopeId", "data-v-93e2b4e6"]]);
export {
  E as default
};
