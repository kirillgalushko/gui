...
import i from "./Select-CqhuFd5o.js";
import { _ as p } from "./SelectOption.vue_vue_type_script_setup_true_lang-D4f4BsRf.js";
const k = /* @__PURE__ */ m({
  __name: "HourPicker",
  props: {
    value: {},
  ...
  setup(o) {
    const e = o, c = Array.from(
      { length: 24 },
      (t, a) => `${String(a).padStart(2, "0")}:00`
    ), u = (t) => {
      var a;
